...
var cnItems = {
    ...
    'Press [1], [2], [3], [4], or [5] to buy the corresponding tier starting from the top. Press [A] to buy Accelerator, [M] to buy Multiplier, or [B] to buy Accelerator Boost. Press [left arrow] or [right arrow] to switch tabs. Enjoy!': '按[1],[2],[3],[4]或[5]来购买生产者,按[A]来购买加速器,[M]来购买加倍,[B]来购买加速器加成,用[←]和[→]来切换转生标签并用[P],[T],[R]转生',
...
var cnPrefix = {
    ...
    'Crystal Production is multiplied based on Particles to the sixth power [Caps at 1e3600x].': '以拥有粒子的六次方提高水晶产量[最大1e3600]',
    'Effect: All crystal production': '效果:所有水晶产量',
    'Mythos Shard Production is multiplied by your Particles to the second power [Caps at 1e1600x].': '以拥有粒子的二次方提高神话碎片产量[最大1e1600]',
    ...
    'Reward: Each completion raises base building power by 0.25 per completion! The first completion unlocks 25 new researches and a new feature: Anthill!': '奖励:每次完成会使建筑效果提升0.25!首次完成会解锁25个新研究和一个新标签:Anthill!',
    '': '',
    '': '',
    '': '',
    '': '',
