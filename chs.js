...
var cnItems = {
    ...
    '[38] High-Tiered: Prestige for at least':'[38]更高阶了：转生获得至少',
    '[39] Highly Regarded: Prestige for at least 1e+100 Diamonds.':'[39]备受推崇：转生获得至少1e100钻石。',
    '[40] Highly Regarded: Prestige for at least':'[40]备受推崇：转生获得至少',
    '[41] Prestigious: Prestige for at least 1e+1000 Diamonds.':'[41]威名远扬：转生获得至少1e1000钻石。',
    '[42] Prestigious: Prestige for at least':'[42]威名远扬：转生获得至少',
    '[43] Legendary: Prestige for at least 1e+10000 Diamonds.':'[43]成为传奇：转生获得至少1e10000钻石。',
    '[44] Legendary: Prestige for at least':'[44]成为传奇：转生获得至少',
    '[45] Divine: Prestige for at least 1e+77777 Diamonds.':'[45]具有神性：转生获得1e77777钻石。',
    '[46] Divine: Prestige for at least':'[46]具有神性：转生获得至少',
    '[47] Perfectly Respected: Prestige for at least 1e+250000 Diamonds.':'[47]无人不知：转生获得1e250000钻石。',
    '[48] Perfectly Respected: Prestige for at least':'[48]无人不知：转生获得至少',
    '[49] A Simple Detour: Transcend for at least 1 Mythos.':'[49]简单迂回：超越获得至少1个神话。',
    '[50] Tunnel Vision: Transcend for at least 1e+6 Mythos.':'[50]井底之蛙：超越获得至少1e6神话。',
    '[51] Risen from the Ashes: Transcend for at least 1e+50 Mythos.':'[51]灰烬重生：超越获得1e50神话。',
    '[52] Paradigm Shift: Transcend for at least 1e+308 Mythos.':'[52]模式转换：超越获得1e308神话。',
    '[53] Preparation: Transcend for at least 1e+2000 Mythos.':'[53]准备工作：超越获得1e2000神话。',
    '[54] Revising the Plan: Transcend for at least 1e+25000 Mythos.':'[54]完善计划：超越获得1e25000神话。',
    '[55] Leaving the Universe: Transcend for at least 1e+100000 Mythos.':'[55]离开宇宙：超越获得1e100000神话。',
    '[56] Going Quantum: Reincarnate for at least 1 Particle.':'[56]量子化：转世获得至少1个粒子。',
    '[57] Tunneling Vision: Reincarnate for at least 100,000 Particles.':'[57]鼠目寸光：转世获得至少100000粒子。',
    '[58] Simulating the World: Reincarnate for at least 1e+30 Particles.':'[58]模拟世界：转世获得1e30粒子。',
    '[59] Multidimensional Creation: Reincarnate for at least 1e+200 Particles.':'[59]多维创造：转世获得1e200粒子。',
    '[60] Lepton Dance: Reincarnate for at least 1e+1500 Particles.':'[60]轻子之舞：转世获得1e1500粒子。',
    '[61] Do we have enough yet?: Reincarnate for at least 1e+5000 Particles.':'[61]还不够吗？：转世获得1e5000粒子。',
    '[62] I Feel Luck in My Cells: Reincarnate for at least 1e+7777 Particles.':'[62]生而为细胞，我很幸运：转世获得1e7777粒子。',
    '[63] One Way Only: Prestige without buying multipliers.':'[63]单行道：不购买加倍器进行一次转生。',
    '[64] Authentic Shifting: Transcend without having bought a multiplier.':'[64]正宗的转变：不购买加倍器进行一次超越。',
    '[65] The Singularity: Reincarnate without having bought a multiplier.':'[65]奇点：不购买加倍器进行一次转世。',
    '[66] Gotta go SLOW!: Prestige without buying Accelerators or Accelerator Boosts.':'[66]得慢点！：不购买加速器和加速器加成进行一次转生。',
    '[67] I\'m really going slow: Transcend without having bought Accelerators or Boosts.':'[67]真的很慢：不购买加速器和加速器加成进行一次超越。',
    '[68] Are we there yet?: Reincarnate without having bought Accelerators or Boosts.':'[68]还没到吗？：不购买加速器和加速器加成进行一次转世。',
    '[69] A careful search for Diamonds: Get 1e120,000 Coins in [Reduced Diamonds] without buying Accelerators or Boosts.':'[69]仔细寻找钻石：在钻石减少挑战中不购买加速器和加速器加成达到e120000金币。',
    '[70] Very Based: Prestige without purchasing Coin Upgrades.':'[70]非常基础：不购买金币升级进行一次转生。',
    '[71] Miser: Transcend without purchasing Coin Upgrades.':'[71]悭吝人：不购买金币升级进行一次超越。',
    '[72] True Miser: Transcend without purchasing Coin or Diamond Upgrades.':'[72]真·守财奴：不购买金币升级和钻石升级进行一次超越。',
    '[73] Coinless Pursuit: Reincarnate without purchasing Coin Upgrades.':'[73]无金币的追求：不购买金币升级进行一次转世。',
    '[74] Diamonds don\'t matter to me!: Reincarnate without purchasing Coin or Diamond Upgrades.':'[74]钻石无用！：不购买金币升级和钻石升级进行一次转世。',
    '[75] Leave nothing behind: Reincarnate without purchasing Coin, Diamond or Mythos Upgrades.':'[75]空手而来：不购买金币升级，钻石升级和神话升级进行一次转世。',
    '[76] Leave NOTHING behind.: Reincarnate without purchasing Coin, Diamond, Mythos, or Generator Upgrades.':'[76]空手而归：不购买金币升级，钻石升级，神话升级和发生器升级进行一次转世。',
    '[77] Out of Order: Buy Generator Upgrade Row 1, #2 first in a transcension (IV -> III)':'[77]顺序错乱：在发生器升级中，首先购买第一排第二项的前提下完成一次超越(图标为IV->III)',
    '[78] Out of Order: Buy Generator Upgrade Row 1, #2 first in a transcension (IV -> III':'[78]顺序错乱：在发生器升级中，首先购买第一排第二项的前提下完成一次超越(图标为IV->III',
    '[79] More Out of Order: Buy Generator Upgrade Row 1, #3 first in a transcension (III -> II)':'[79]更严重的错乱：在发生器升级中，首先购买第一排第三项的前提下完成一次超越(图标为III->II)',
    '[80] More Out of Order: Buy Generator Upgrade Row 1, #3 first in a transcension (III -> II':'[80]更严重的错乱：在发生器升级中，首先购买第一排第三项的前提下完成一次超越(图标为III->II',
    '[81] Four\'s a Company: Buy Generator Upgrade Row 1, #4 first in a transcension (II -> I)':'[81]四人成伴：在发生器升级中，首先购买第一排第四项的前提下完成一次超越(图标为II->I)',
    '[82] Four\'s a Company: Buy Generator Upgrade Row 1, #4 first in a transcension (II -> I':'[82]四人成伴：在发生器升级中，首先购买第一排第四项的前提下完成一次超越(图标为II->I',
    '[83] Five\'s a Croud: Buy Generator Upgrade Row 1, #5 first in a transcension (I -> V)':'[83]五人不欢：在发生器升级中，首先购买第一排第五项的前提下完成一次超越(图标为I->V)',
    '[84] Five\'s a Croud: Buy Generator Upgrade Row 1, #5 first in a transcension (I -> V':'[84]五人不欢：在发生器升级中，首先购买第一排第五项的前提下完成一次超越(图标为I->V',
    '[85] Vaseline without the Machine: Exit [No Multiplier] with at least 1e1000 coins and without any of the row 1 generator upgrades.':'[85]有润滑油却没有机器：在拥有1e1000金币并且不购买第一排(横向)发生器升级的前提下退出无加倍器挑战。',
    '[86] Rage against the Machine: Exit [No Accelerator] with at least 1e1000 coins and without any of the row 1 generator upgrades.':'[86]对机器发脾气：在拥有1e1000金币并且不购买第一排(横向)发生器升级的前提下退出无加速器挑战。',
    '[87] Amish Paradise: Exit [No Shards] with at least 1e99,999 coins and without any of the row 1 generator upgrades.':'[87]阿米什人的天堂：在拥有1e99999金币并且不购买第一排(横向)发生器升级的前提下退出无碎片挑战。',
    '[88] Single-Cell: Complete [No Multiplier] once.':'[88]第一部分：完成一次无加倍器挑战。',
    '[89] Solidarity: Complete [No Multiplier] three times.':'[89]精诚团结：完成三次无加倍器挑战。',
    '[90] Duplication-Free!: Complete [No Multiplier] five times.':'[90]重叠自由！：完成五次无加倍器挑战。',
    '[91] Multitasking Challenged: Complete [No Multiplier] ten times.':'[91]多重挑战：完成十次无加倍器挑战。',
    '[92] No Deaths: Complete [No Multiplier] twenty times.':'[92]不会死亡：完成二十次无加倍器挑战。',
    '[93] Population One: Complete [No Multiplier] fifty times.':'[93]炼蛊：完成五十次无加倍器挑战。',
    '[94] Insert Another Token: Complete [No Multiplier] seventy-five times.':'[94]该投币了：完成七十五次无加倍器挑战。',
    '[95] Slow Start: Complete [No Accelerator] once':'[95]缓慢启动：完成一次无加速器挑战。',
    '[96] Respawn Rate -12%: Complete [No Accelerator] three times.':'[96]重生速率-12%：完成三次无加速器挑战。',
    '[97] Putting the Breaks On: Complete [No Accelerator] five times.':'[97]踩住刹车：完成五次无加速器挑战。',
    '[98] Racing a Sloth...: Complete [No Accelerator] ten times.':'[98]比懒大赛……：完成十次无加速器挑战。',
    '[99] ... and Losing.: Complete [No Accelerator] twenty times.':'[99]……然后输了。：完成二十次无加速器挑战。',
    '[100] Planck Distance Traveled: Complete [No Accelerator] fifty times.':'[100]只走了普朗克长度而已：完成五十次无加速器挑战。',
    '[101] Inverse-Ackermann Growth: Complete [No Accelerator] seventy-five times.':'[101]反阿克曼函数增长：完成七十五次无加速器挑战。',
    '[102] Intact: Complete [No Shards] once.':'[102]完好无缺：完成一次无碎片挑战。',
    '[103] Augments are Stupid!: Complete [No Shards] three times.':'[103]强化太蠢了！：完成三次无碎片挑战。',
    '[104] Grandmasters are Brilliant!: Complete [No Shards] five times.':'[104]宗师太聪明了！：完成五次无碎片挑战。',
    '[105] Gotta get those Grandmasters Stronger: Complete [No Shards] ten times.':'[105]加强宗师：完成十次无碎片挑战。',
    '[106] Summoning Enhancements: Complete [No Shards] twenty times.':'[106]召唤附魔：完成二十次无碎片挑战。',
    '[107] Magic 99/99: Complete [No Shards] fifty times.':'[107]魔法99/99：完成五十次无碎片挑战。',
    '[108] Perfect Foresight: Complete [No Shards] seventy-five times.':'[108]完全预见：完成七十五次无碎片挑战。',
    '[109] Inflation: Complete [Cost+] once.':'[109]通货膨胀：完成一次花费增加挑战。',
    '[110] Hyperinflation: Complete [Cost+] three times.':'[110]恶性通货膨胀：完成三次花费增加挑战。',
    '[111] Market Bubble: Complete [Cost+] five times.':'[111]市场泡沫：完成五次花费增加挑战。',
    '[112] Bull Market: Complete [Cost+] ten times.':'[112]牛市：完成十次花费增加挑战。',
    '[113] Wealth Inequality: Complete [Cost+] twenty times.':'[113]贫富不均：完成二十次花费增加挑战。',
    '[114] Severe Overpay: Complete [Cost+] fifty times.':'[114]工资虚高：完成五十次花费增加挑战。',
    '[115] Societal Collapse: Complete [Cost+] seventy-five times.':'[115]社会崩溃：完成七十五次花费增加挑战。',
    '[116] Excavation: Complete [Reduced Diamonds] once.':'[116]挖掘：完成一次钻石减少挑战。',
    '[117] Digging Deep: Complete [Reduced Diamonds] three times.':'[117]深挖：完成三次钻石减少挑战。',
    '[118] Frack As Needed: Complete [Reduced Diamonds] five times.':'[118]需要压碎：完成五次钻石减少挑战。',
    '[119] Unobtainium Pickaxe: Complete [Reduced Diamonds] ten times.':'[119]难得素之镐：完成十次钻石减少挑战。',
    '[120] Fortune III: Complete [Reduced Diamonds] twenty times.':'[120]命运 III：完成二十次钻石减少挑战。',
    '[121] Every kiss...: Complete [Reduced Diamonds] fifty times.':'[121]钻石恒久远：完成五十次钻石减少挑战。',
    '[122] ...begins with K.: Complete [Reduced Diamonds] seventy-five times.':'[122]一颗永流传：完成七十五次钻石减少挑战。',
    '[123] Tax evasion!: Complete {[Tax+]} once.':'[123]逃税！：完成一次税收增加挑战。',
    '[124] Keeping up with the Joneses: Complete {[Tax+]} twice.':'[124]攀比：完成两次税收增加挑战。',
    '[125] Offshore deposits: Complete {[Tax+]} three times.':'[125]海外存款：完成三次税收增加挑战。',
    '[126] Bribing officials: Complete {[Tax+]} five times.':'[126]贿赂官员：完成五次税收增加挑战。',
    '[127] Becoming President: Complete {[Tax+]} ten times.':'[127]正在成为总统：完成十次税收增加挑战。',
    '[128] Charitable Donation: Complete {[Tax+]} fifteen times.':'[128]慈善捐款：完成十五次税收增加挑战。',
    '[129] IRS Audit: Complete {[Tax+]} twenty-five times.':'[129]税务审计：完成二十五次税收增加挑战。',
    '[130] Is there anybody in there?: Complete {[No Accelerator/Multiplier]} once.':'[130]还有人在吗？：完成一次无加倍器/加速器挑战。',
    '[131] Human being: Complete {[No Accelerator/Multiplier]} twice.':'[131]人类：完成两次无加倍器/加速器挑战。',
    '[132] Interdimensional: Complete {[No Accelerator/Multiplier]} three times.':'[132]多维度：完成三次无加倍器/加速器挑战。',
    '[133] A slow nickel: Complete {[No Accelerator/Multiplier]} five times.':'[133]薄利多销：完成五次无加倍器/加速器挑战。',
    '[134] Multipliers don\'t even work 0/5: Complete {[No Accelerator/Multiplier]} ten times.':'[134]加倍器没效果，游戏评分0/5：完成十次无加倍器/加速器挑战。',
    '[135] Accelerators don\'t even work -5/5: Complete {[No Accelerator/Multiplier]} fifteen times.':'[135]加速器也没效果，游戏评分-5/5：完成十五次无加倍器/加速器挑战。',
    '[136] ACCELERATOR BOOSTS DON\'T EVEN WORK -100/5: Complete {[No Accelerator/Multiplier]} twenty-five times.':'[136]连加速器加成都没效果，游戏评分-100/5：完成二十五次无加倍器/加速器挑战。',
    '[137] I hate this challenge: Complete Cost++ Once.':'[137]我恨这个挑战：完成一次花费暴增挑战。',
    '[138] A costly mistake: Complete Cost++ Twice.':'[138]代价高昂的错误：完成两次花费暴增挑战。',
    '[139] Impetus: Complete Cost++ Three Times.':'[139]原动力：完成三次花费暴增挑战。',
    '[140] Are you broke yet? Complete Cost++ Five Times.':'[140]您破产了吗？：完成五次花费暴增挑战。',
    '[141] The world of Finance: Complete Cost++ Ten Times.':'[141]金融世界：完成十次花费暴增挑战。',
    '[142] Marginal Gains: Complete Cost++ Twenty Times.':'[142]边际收益：完成二十次花费暴增挑战。',
    '[143] I buy these: Complete Cost++ Twenty-Five Times.':'[143]这些我买了：完成二十五次花费暴增挑战。',
    '[144] Agnostic: Complete No Runes Once.':'[144]不可知论：完成一次无符文挑战。',
    '[145] Ant-i Runes: Complete No Runes Twice.':'[145]反蚁符文：完成两次无符文挑战。',
    '[146] Isn\'t it getting tiresome?: Complete No Runes Three Times.':'[146]是不是有点厌烦了？：完成三次无符文挑战。',
    '[147] Machine does not accept offerings: Complete No Runes Five Times.':'[147]机器不接受祭品：完成五次无符文挑战。',
    '[148] Runes Suck 1/5: Complete No Runes Ten Times.':'[148]符文弱爆了，游戏评分1/5：完成十次无符文挑战。',
    '[149] I didn\'t even notice Prism was gone: Complete No Runes Twenty Times.':'[149]棱镜符文什么时候不见了：完成二十次无符文挑战。',
    '[150] Atheist: Complete No Runes Twenty-Five Times.':'[150]无神论：完成二十五次无符文挑战。',
    '[151] Sadism: Complete {[Sadistic I]} Once.':'[151]抖S：完成一次虐待狂挑战 I。',
    '[152] Masochism: Complete {[Sadistic I]} Twice.':'[152]抖M：完成两次虐待狂挑战 I。',
    '[153] Insanity: Complete {[Sadistic I]} Three Times.':'[153]精神错乱：完成三次虐待狂挑战 I。',
    '[154] How? Complete {[Sadistic I]} Five Times.':'[154]怎么？完成五次虐待狂挑战 I。',
    '[155] Why? Complete {[Sadistic I]} Ten Times.':'[155]为何？完成十次虐待狂挑战 I。',
    '[156] Descend: Complete {[Sadistic I]} Twenty Times.':'[156]落凡：完成二十次虐待狂挑战 I。',
    '[157] End of the Universe: Complete {[Sadistic I]} Twenty-Five Times.':'[157]宇宙的尽头：完成二十五次虐待狂挑战 I。',
    '[158] Gas gas gas: Purchase 5 Accelerators.':'[158]Gas gas gas(头文字D主题曲)：购买5个加速器。',
    '[159] 0 to 25: Purchase 25 Accelerators.':'[159]从0到25：购买25个加速器。',
    '[160] 0 to 100: Purchase 100 Accelerators':'[160]从0到100：购买100个加速器。',
    '[161] Highway to Hell: Purchase 666 Accelerators.':'[161]地狱公路：购买666个加速器。',
    '[162] Perhaps you should brake: Purchase 2,000 Accelerators.':'[162]您该刹车了：购买2000个加速器。',
    '[163] Exit the vehicle now!: Purchase 12,500 Accelerators.':'[163]快下车！：购买12500个加速器。',
    '[164] Faster than light: Purchase 100,000 Accelerators.':'[164]超越光速：购买100000个加速器。',
    '[165] I\'ve been duped!: Purchase 2 Multipliers.':'[165]我重叠了！：购买2个加倍器。',
    '[166] Funhouse Mirrors: Purchase 20 Multipliers.':'[166]哈哈镜：购买20个加倍器。',
    '[167] Friend of binary: Purchase 100 Multipliers.':'[167]二进制之友：购买100个加倍器。',
    '[168] Feeling the cost growth yet?: Purchase 500 Multipliers.':'[168]感觉到成本飞涨了吗？：购买500个加倍器。',
    '[169] Perhaps you\'ll feel the cost now: Purchase 2,000 Multipliers.':'[169]该感觉到了吧：购买2000个加倍器。',
    '[170] Exponential Synergy: Purchase 12,500 Multipliers.':'[170]指数协同：购买12500个加倍器。',
    '[171] Cloned: Purchase 100,000 Multipliers.':'[171]克隆：购买100000个加倍器。',
    '[172] Jerk > 0: Purchase 2 Accelerator Boosts.':'[172]加加速度大于0：购买2个加速器加成。',
    '[173] Can\'t the speedometer move any faster?: Purchase 10 Accelerator Boosts.':'[173]速度计就不能更快点吗？：购买10个加速器加成。',
    '[174] 50 G rotations: Purchase 50 Accelerator Boosts.':'[174]50个G的轮转：购买50个加速器加成。',
    '[175] Dematerialize: Purchase 200 Accelerator Boosts.':'[175]非物虚化：购买200个加速器加成。',
    '[176] Breaking the laws of Physics: Purchase 1,000 Accelerator Boosts.':'[176]正在打破物理法则：购买1000个加速器加成。',
    '[177] Decayed Realism: Purchase 5,000 Accelerator Boosts.':'[177]现实主义被扫进了垃圾堆：购买5000个加速器加成。',
    '[178] Kinda fast: Purchase 15,000 Accelerator Boosts.':'[178]有点快欸：购买15000个加速器加成。',
    '[179] The Galactic Feast: Obtain 3 Galactic Crumbs.':'[179]银河盛宴：获得3个银河碎屑。',
    '[180] Only the finest: Obtain 100,000 Galactic Crumbs.':'[180]食不厌精：获得100000个银河碎屑。',
    '[181] Six-Course Meal: Obtain 666,666,666 Galactic Crumbs.':'[181]六道菜的大餐：获得666666666个银河碎屑。',
    '[182] Accumulation of Food: Obtain 1e20 Galactic Crumbs.':'[182]囤积食物：获得1e20个银河碎屑。',
    '[183] Cookie Clicking: Obtain 1e40 Galactic Crumbs.':'[183]点击饼干：获得1e40个银河碎屑。',
    '[184] Unlimited Bread Sticks!: Obtain 1e500 Galactic Crumbs.':'[184]无限的面包棒！：获得1e500个银河碎屑。',
    '[185] Restaurant at the end of the Universe: Obtain 1e2500 Galactic Crumbs.':'[185]宇宙尽头的餐馆：获得1e2500个银河碎屑。',
    '[186] Ant-icipation!: Amass a 2x Ant Multiplier through sacrifice and own a Tier 2 ant.':'[186]蚁之期待！：通过献祭获得2x的蚂蚁倍率并拥有一个T2蚂蚁。',
    '[187] Ant-ecedent: Amass a 6x Ant Multiplier through sacrifice and own a Tier 3 ant.':'[187]蚁之前提：通过献祭获得6x的蚂蚁倍率并拥有一个T3蚂蚁。',
    '[188] Ants are friends, not food!: Amass a 20x Ant Multiplier through sacrifice and own a Tier 4 Ant.':'[188]蚂蚁是朋友，不是食物！：通过献祭获得20x的蚂蚁倍率并拥有一个T4蚂蚁。',
    '[189] Ant Devil?: Amass a 100x Ant Multiplier through sacrifice and own a Tier 5 Ant.':'[189]蚁之魔？：通过献祭获得100x的蚂蚁倍率并拥有一个T5蚂蚁。',
    '[190] The world\'s best chef: Amass a 500x Ant Multiplier through sacrifice and own a Tier 6 Ant.':'[190]世界上最好的厨师：通过献祭获得500x的蚂蚁倍率并拥有一个T6蚂蚁。',
    '[191] 6 Michelin Stars: Amass a 6,666x Ant Multiplier through sacrifice and own a Tier 7 Ant.':'[191]米其林6星：通过献祭获得6666x的蚂蚁倍率并拥有一个T7蚂蚁。',
    '[192] Keys to the Restaurant at the end of the Universe: Amass a 77,777x Ant Multiplier through sacrifice and own a Tier 8 Ant.':'[192]宇宙尽头的餐馆的钥匙：通过献祭获得77777x的蚂蚁倍率并拥有一个T8蚂蚁。',
    '[193] Up: Ascend Once.':'[193]向上走：进行1次飞升。',
    '[194] Double-Up: Ascend Twice.':'[194]双倍向上：进行2次飞升。',
    '[195] Give me Ten!: Ascend Ten Times.':'[195]我要打十个！进行10次飞升。',
    '[196] Give me a Hundred: Ascend 100 Times.':'[196]一百个也一样：进行100次飞升。',
    '[197] Give me a Thousand: Ascend 1,000 Times.':'[197]一千个也一样：进行1000次飞升。',
    '[198] Give me some arbitrary number I: Ascend 14,142 Times.':'[198]随便多少都一样：进行14142次飞升。',
    '[199] Give me some arbitrary number II: Ascend 141,421 Times.':'[199]一个能打的都没有：进行141421次飞升。',
    '[200] Now that\'s what I call getting some Pi!: Attain a constant of 3.14.':'[200]这就是所谓的Pi了：达到3.14的数学常数。',
    '[201] One in a million: Attain a constant of 1,000,000 [1e6].':'[201]万里挑一：达到1000000[1e6]的数学常数。',
    '[202] A number: Attain a constant of 4.32e10.':'[202]一个数字：达到4.32e10的数学常数。',
    '[203] The coolest of numbers: Attain a constant of 6.9e21.':'[203]最棒的数字：达到6.9e21的数学常数。',
    '[204] Planck^(-1): Attain a constant of 1.509e33.':'[204]普朗克常数的倒数：达到1.509e33的数学常数。',
    '[205] Epsilon > a lot: Attain a constant of 1e66.':'[205]无穷小也比很多数大：达到1e66的数学常数。',
    '[206] NUM_MAX: Attain a constant of 1.8e308.':'[206]最大的常数：达到1.8e308的数学常数。',
    '[207] Casualties: Clear \'Reduced Ants\' challenge once.':'[207]伤亡：完成一次蚂蚁减少挑战。',
    '[208] Fatalities: Clear \'Reduced Ants\' challenge twice.':'[208]死亡：完成两次蚂蚁减少挑战。',
    '[209] Destruction: Clear \'Reduced Ants\' challenge three times.':'[209]毁灭：完成三次蚂蚁减少挑战。',
    '[210] War, what is it good for?: Clear \'Reduced Ants\' challenge five times.':'[210]战争，是为何而战？：完成五次蚂蚁减少挑战。',
    '[211] Absolutely everything.: Clear \'Reduced Ants\' challenge ten times.':'[211]当然是为了一切。：完成十次蚂蚁减少挑战。',
    '[212] Perfect Storm: Clear \'Reduced Ants\' challenge twenty times.':'[212]祸不单行：完成二十次蚂蚁减少挑战。',
    '[213] Immaculate Storm: Clear \'Reduced Ants\' challenge thirty times.':'[213]屋漏偏逢连夜雨：完成二十五次蚂蚁减少挑战。',
    '[214] I didn\'t need those stupid reincarnations anyway!: Clear \'No Reincarnation\' challenge once.':'[214]没用的转世说丢就丢！：完成一次无转世挑战。',
    '[215] [x1,x2,0,x3]: Clear \'No Reincarnation\' challenge twice.':'[215][x1,x2,0,x3]：完成两次无转世挑战。',
    '[216] Nonmetaphysical: Clear \'No Reincarnation\' challenge three times.':'[216]非玄学：完成三次无转世挑战。',
    '[217] Living alone: Clear \'No Reincarnation\' challenge five times.':'[217]离群索居：完成五次无转世挑战。',
    '[218] DM me on discord if you read these names: Clear \'No Reincarnation\' challenge ten times.':'[218]如果您读了这些名字就在Discord上私聊我：完成十次无转世挑战。',
    '[219] Yeah: Clear \'No Reincarnation\' challenge twenty times.':'[219]是的：完成二十次无转世挑战。',
    '[220] Science! Clear \'No Reincarnation\' challenge thirty times.':'[220]科学！完成三十次无转世挑战。',
    '[221] The IRS strikes back: Clear \'Tax+++\' challenge once.':'[221]税务局杀回来了：完成一次税收激增挑战。',
    '[222] Fiscal Policy: Clear \'Tax+++\' challenge twice.':'[222]财政政策：完成两次税收激增挑战。',
    '[223] Economic Boom: Clear \'Tax+++\' challenge three times.':'[223]经济繁荣：完成三次税收激增挑战。',
    '[224] Ant-onomics: Clear \'Tax+++\' challenge five times.':'[224]蚂蚁经济学：完成五次税收激增挑战。',
    '[225] \'Wow Platonic Tax sucks 1/5\': Clear \'Tax+++\' challenge ten times.':'[225]\'Platonic的税收弱爆了，游戏评分1/5\'：完成十次税收激增挑战。',
    '[226] Haha this is hard for some reason: Clear \'Tax+++\' challenge twenty times.':'[226]哈哈因为某些原因这是有点难：完成二十次税收激增挑战。',
    '[227] Taxes are hard: Clear \'Tax+++\' challenge thirty times.':'[227]严苛的税收：完成三十次税收激增挑战。',
    '[228] Shiny Blue Rock: Clear \'No Research\' once.':'[228]发亮的蓝石：完成一次无研究挑战。',
    '[229] It\'s like Avatar: Clear \'No Research\' twice.':'[229]就像阿凡达一样：完成二次无研究挑战。',
    '[230] It\'s like Unobtainium: Clear \'No Research\' three times.':'[230]这回真的难得了：完成三次无研究挑战。',
    '[231] It\'s like a thing: Clear \'No Research\' five times.':'[231]就像那啥一样：完成五次无研究挑战。',
    '[232] It\'s like: Clear \'No Research\' ten times.':'[232]就像那啥：完成十次无研究挑战。',
    '[233] It\'s: Clear \'No Research\' twenty times.':'[233]就像：完成二十次无研究挑战。',
    '[234] It: Clear \'No Research\' thirty times.':'[234]就：完成三十次无研究挑战。',
    '[235] Pretty Corrupt: Clear an Ascension with above 100,000 score.':'[235]相当腐化：以十万以上的分数完成飞升。',
    '[236] Bought out: Clear an Ascension with above 1 million score.':'[236]买断：以一百万以上的分数完成飞升。',
    '[237] Utterly Corrupt: Clear an Ascension with above 10 million score.':'[237]完全腐化：以一千万以上的分数完成飞升。',
    '[238] Antitrust: Clear an Ascension with above 100 million score.':'[238]反垄断：以一亿以上的分数完成飞升。',
    '[239] Ant-i-trust: Clear an Ascension with above 1 billion score.':'[239]蚁之反垄断：以十亿以上的分数完成飞升。',
    '[240] This is pretty unfair: Clear an Ascension with above 5 billion score.':'[240]这一点也不公平：以五十亿以上的分数完成飞升。',
    '[241] Antichrist: Clear an Ascension with above 25 billion score.':'[241]反基督者：以二百五十亿以上的分数完成飞升。',
    '[242] Highly Blessed: Level your Speed Rune blessing to 100,000.':'[242]高度祝福：将加速符文的祝福等级提升到十万。',
    '[243] Divine Blessing: Level your Speed Rune blessing to 100,000,000.':'[243]神圣祝福：将加速符文的祝福等级提升到一亿。',
    '[244] Blessing III: Level your Speed Rune blessing to 100 billion.':'[244]祝福 III：将加速符文的祝福等级提升到一千亿。',
    '[245] Spirit I: Level your Speed Spirit to 1 Million.':'[245]魂灵 I：将加速符文的魂灵等级提升到一百万。',
    '[246] Spirit II: Level your Speed Spirit to 1 Billion.':'[246]魂灵 II：将加速符文的魂灵等级提升到十亿。',
    '[247] Spirit III: Level your Speed Spirit to 1 Trillion.':'[247]魂灵 III：将加速符文的魂灵等级提升到一万亿。',
    '[248] Three-folded: [Hint: you may want to look into the inception]':'[248]三次折扣：[提示：想想一路走来，有什么刚好可以三重叠加的]',
    '[249] Seeing red: [Hint: you may need a lot of red items]':'[249]红色危机：[提示：这个游戏中，有什么资源基本全是红色的，当然不是说什么立方，您需要很多那种资源，有多少？应该不是1后面跟25个0啥的了]',
    '[250] ASCENDED: [Hint: you may need a LOT of ascensions OR a particularly amazing ascension]':'[250]多次飞升：[提示：在之前飞升成就的基础上，再多一位，至于是哪一位？肯定跟根号2没关系的]',
    '[251] Aesop: [Hint: you gotta be pretty dang slow]':'[251]伊索：[提示：想想哪个腐化会减慢速度，不要低于6级]',
    '[252] Aesop\'s Revenge: [Hint: you gotta be pretty dang fast]':'[252]伊索的复仇：[提示：与上个成就相反，速度的倍率需要大于一个数字，当然不是大于1小时的秒数]',
    '[253] Unsmith: [Hint: unsmith emoji :unsmith: can be a pretty good input]':'[253]面无表情：[提示：奖励代码输入 :unsmith: ]',
    '[254] Smith: [Hint: :antismith: looks promising as well]':'[254]反色面无表情：[提示：奖励代码输入 :antismith: ]',
    '[255] BLESSED: [Hint: Your Speed Blessing best be unreasonably high!]':'[255]彻底祝福：[提示：加速符文的祝福等级需要大到离谱，甚至是1e14的一亿倍]',
    '[256] Why? [Hint: Sometimes even 1 in over a Trillion counts!]':'[256]意义何在？[提示：在赫尔墨斯的祝福等级已经比一千万的两万倍还多时，再去开一个方盒又有什么意义呢，对不对？]',
    '[257] Challenging! [Hint: Challenge 11 is calling your name, but with even less ants]':'[257]真正的挑战！[提示：使用某个跟蚂蚁产量有关的腐化以后，完成挑战11，且本次完成挑战10的次数不能低于49，也不需要高于51？什么，腐化要多少级？挑战10至少需要次数的第一位就是了]',
    '[258] Seeing Red but not Blue: [Hint: Can you get red stuff without getting blue stuff?]':'[258]无蓝见红：[提示：在某个见不到发亮蓝石的挑战中，获得1后面跟着10个0……哦不好意思还少了个0的某种红色资源。什么资源？前面不是有一个一样的吗，就那个]',
    '[259] Overtaxed: [Hint: It might pay not to read!]':'[259]课税过重：[提示：在某个税收增加极快的挑战，当然不是那种转转世就能完成的挑战中，由于税收，金币产量连1后面跟着1，2，3……等等，多少来着，哦，100……1000？不不，100000个0都达不到]',
    '[260] The Thousand Suns: [Hint: You need to fully research into becoming GOD]':'[260]烈日千阳：[提示：将某个最后出现的研究提升至最大]',
    '[261] The Thousand Moons: [Hint: You may need to cube yourself up]':'[261]静月千阴：[提示：将方盒最后的某个升级提升至最大]',
    '[262] Ultimate: Complete \'SADISTIC II\' challenge.':'[262]终级挑战：完成虐待狂挑战 II。',
    ...
    'Reward: 100 AP. 100 Quarks! Gain (log10(Constant+1)/50)% more Platonic Cubes on ascension!': '奖励：100成就点数。100夸克！飞升时PLATONIC方盒获取数量增加 (log10(数学常数数量+1)/50)% ！',
    ...
    'Reward: 100 AP. 100 Quarks! Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions (max 24 hours). Gain +0.1% Hypercubes per 1,000,000 ascensions, up to +200%!': '奖励：100成就点数。100夸克！飞升时间超过10秒以后，超出部分的时间(最高24小时)的2%将变为飞升次数的倍率。且每1000000次飞升使五阶立方获取数量增加0.1%，最大为200%！',
    ...
    'Reward: 100 AP. 100 Quarks! Gain +3% Platonic Cubes on ascension!': '奖励：100成就点数。100夸克！飞升时PLATONIC方盒获取数量增加3%！',
    'Reward: 100 AP. 100 Quarks! Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions (max 24 hours). Gain +0.1% Platonic Cubes per 1,337,000 ascensions, up to +200%!': '奖励：100成就点数。100夸克！飞升时间超过10秒以后，超出部分的时间(最高24小时)的2%将变为飞升次数的倍率。且每1337000次飞升使PLATONIC方盒获取数量增加0.1%，最大为200%！',
    'Reward: 40 AP. 40 Quarks! Ascension Cube Gain Multipliers is VERY slightly affected by global speed multipliers: 1 + log10(Speed)/20 (Min: 1.10x, Max': '奖励：40成就点数。40夸克！飞升时方盒获取数量受到全局速度轻微的影响，公式为：1 + log10(全局速度)/20 (最小值: 1.10x，最大值',
    'Reward: 100 AP. 100 Quarks! You gain a permanent +60% Obtainium and Offering bonus, with +6% all cube types! You also get +10% Quarks forever (additive)!': '奖励：100成就点数。100夸克！难得素和祭品获得数量永久增加60%，所有类型的方盒及立方获取数量永久增加6%！另外，夸克获取数量永久增加10%(相互叠加)！',
    'Reward: 100 AP. 100 Quarks! You gain a permanent +100% Obtainium and Offering bonus, with +10% all cube types! You also get +10% Quarks forever (additive)!': '奖励：100成就点数。100夸克！难得素和祭品获得数量永久增加100%，所有类型的方盒及立方获取数量永久增加10%！另外，夸克获取数量永久增加10%(相互叠加)！',
