...
var cnItems = {
    ...
    'Vaseline without the Machine: Exit [No Multiplier] with at least 1e1000 coins and without any of the row 1 generator upgrades.': '有润滑油却没有机器：在拥有1e1000金币并且不购买第一排(横向)发生器升级的前提下退出无加倍挑战。',
    'Rage against the Machine: Exit [No Accelerator] with at least 1e1000 coins and without any of the row 1 generator upgrades.': '对机器发脾气：在拥有1e1000金币并且不购买第一排(横向)发生器升级的前提下退出无加速挑战。',
    ...
    'Solidarity: Complete [No Multiplier] three times.': '精诚团结：完成三次无加倍挑战。',
    'Duplication-Free!: Complete [No Multiplier] five times.': '重叠自由！：完成五次无加倍挑战。',
    ...
    'Population One: Complete [No Multiplier] fifty times.': '炼蛊：完成五十次无加倍挑战。',
    'Insert Another Token: Complete [No Multiplier] seventy-five times.': '该投币了：完成七十五次无加倍挑战。',
    'Slow Start: Complete [No Accelerator] once': '缓慢启动：完成一次无加速挑战。',
    'Respawn Rate -12%: Complete [No Accelerator] three times.': '重生速率-12%：完成三次无加速挑战。',
    'Putting the Breaks On: Complete [No Accelerator] five times.': '踩住刹车：完成五次无加速挑战。',
    'Racing a Sloth...: Complete [No Accelerator] ten times.': '比懒大赛……：完成十次无加速挑战。',
    '... and Losing.: Complete [No Accelerator] twenty times.': '……然后输了。：完成二十次无加速挑战。',
    'Planck Distance Traveled: Complete [No Accelerator] fifty times.': '只走了普朗克长度而已：完成五十次无加速挑战。',
    'Inverse-Ackermann Growth: Complete [No Accelerator] seventy-five times.': '反阿克曼函数增长：完成七十五次无加速挑战。',
    ...
    'Tax evasion!: Complete {[Tax+]} once.': '逃税！：完成一次税收暴增挑战。',
    'Keeping up with the Joneses: Complete {[Tax+]} twice.': '攀比：完成两次税收暴增挑战。',
    'Offshore deposits: Complete {[Tax+]} three times.': '海外存款：完成三次税收暴增挑战。',
    'Bribing officials: Complete {[Tax+]} five times.': '贿赂官员：完成五次税收暴增挑战。',
    'Becoming President: Complete {[Tax+]} ten times.': '正在成为总统：完成十次税收暴增挑战。',
    'Charitable Donation: Complete {[Tax+]} fifteen times.': '慈善捐款：完成十五次税收暴增挑战。',
    'IRS Audit: Complete {[Tax+]} twenty-five times.': '税务审计：完成二十五次税收暴增挑战。',
    'Is there anybody in there?: Complete {[No Accelerator/Multiplier]} once.': '还有人在吗？：完成一次无加倍/加速挑战。',
    'Human being: Complete {[No Accelerator/Multiplier]} twice.': '人类：完成两次无加倍/加速挑战。',
    'Interdimensional: Complete {[No Accelerator/Multiplier]} three times.': '多维度：完成三次无加倍/加速挑战。',
    'A slow nickel: Complete {[No Accelerator/Multiplier]} five times.': '薄利多销：完成五次无加倍/加速挑战。',
    'Multipliers don\'t even work 0/5: Complete {[No Accelerator/Multiplier]} ten times.': '加倍器没效果，游戏评分0/5：完成十次无加倍/加速挑战。',
    'Accelerators don\'t even work -5/5: Complete {[No Accelerator/Multiplier]} fifteen times.': '加速器也没效果，游戏评分-5/5：完成十五次无加倍/加速挑战。',
    'ACCELERATOR BOOSTS DON\'T EVEN WORK -100/5: Complete {[No Accelerator/Multiplier]} twenty-five times.': '连加速器加成都没效果，游戏评分-100/5：完成二十五次无加倍/加速挑战。',
    ...
    'Give me a Thousand: Ascend 1,000 Times.': '一千个也一样：进行100次飞升。',
    ...
    'Challenging! [Hint: Challenge 11 is calling your name, but with even less ants]': '真正的挑战！[提示：使用某个跟蚂蚁产量有关的腐化以后，完成挑战11，且本次完成挑战10的次数不能低于49，也不需要高于51？什么，腐化要多少级？挑战10的次数第一位就是了]',
    ...
    'To leave a challenge, press the hotkey listed above OR click on the red Challenge "C" button on the reset buttons on top.': '想要退出挑战，您可以按列表里的快捷键或者点击上方转生按钮右边的C按钮',
    ...
    'Go through a transcension, except prestiging rewards scale much more slowly. Diamond generation is also debuffed, and Reduced Diamondsboosting upgrades are disabled. Gets harder each completion!': '立即完成一次超越,转生收益将变得非常低,钻石收益也被严重削减,并且所有增加钻石产量的升级无效,每次完成后都会变得更难!',
