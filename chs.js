...
var cnItems = {
    ...
    'Gain free Accelerators based on Unspent Diamonds.': '根据未花费的钻石获得免费加速器。',
    ...
    'Multiply mythos shard production by the squared logarithm of Diamonds.': '将神话碎片产量乘以钻石对数的平方。',
    ...
    'Multiply Mythos Shard production based on unspent Diamonds.': '根据未花费的钻石增加神话碎片产量。',
    ...
    'When bought, rune effectiveness is increased by Log4(Talisman Shards +': '(译者注：注意，与升级等级无关)购买后，符文效果增加 Log4(护身符灰底碎片 +',
