...
var cnItems = {
    ...
    '[1x6] Gain +5% free accelerators per level.': '[1x6]每级增加5%免费加速器。',
    '[1x7] Gain +4% free accelerators per level.': '[1x7]每级增加4%免费加速器。',
    '[1x8] Gain +3% free accelerators per level.': '[1x8]每级增加3%免费加速器。',
    '[1x9] Gain +2% free accelerators per level.': '[1x9]每级增加2%免费加速器。',
    '[1x10] Gain +2% free accelerators per level.': '[1x10]每级增加2%免费加速器。',
    '[1x11] Gain +5% free multipliers per level.': '[1x11]每级增加5%免费加倍器。',
    '[1x12] Gain +4% free multipliers per level.': '[1x12]每级增加4%免费加倍器。',
    '[1x13] Gain +2.5% free multipliers per level.': '[1x13]每级增加2.5%免费加倍器。',
    '[1x14] Gain +1.5% free multipliers per level.': '[1x14]每级增加1.5%免费加倍器。',
    '[1x15] Gain +0.5% free multipliers per level.': '[1x15]每级增加0.5%免费加倍器。',
    '[1x16] Gain +5% free accelerator boosts per level.': '[1x16]每级增加5%免费加速器加成。',
    '[1x17] Gain +5% free accelerator boosts per level.': '[1x17]每级增加5%免费加速器加成。',
