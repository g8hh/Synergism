...
export const areward = (i: number): string => {
    ...
    const descs: {[key: number]: string} = {
        ...
        115: '祭品回收概率增加5%。',
        117: '税收增长减缓5.66%。',
        118: `每完成一次任意转世挑战，税收增长就减缓0.75%，效果叠乘。效果：${format(Math.pow(0.9925, player.challengecompletions[6] + player.challengecompletions[7] + player.challengecompletions[8] + player.challengecompletions[9] + player.challengecompletions[10]), 4)}x`,
        ...
        278: '夸克获取数量永久增加5%！(隐藏效果：进入奇点后直接获得商店的EX额外祭品、AUTO自动献祭祭品、EX额外难得素、AUTO难得素自动研究、蚂蚁速度、昂贵物品各10级，可以重置这些升级获得夸克)',
        279: '进入奇点后直接完成一次挑战7，并获得1e100粒子。护身符的额外等级对所有符文均生效！',
        280: '进入奇点后直接完成一次挑战8，并获得一只工蚁。(隐藏效果：进入奇点后直接完成成就176至成就182) ---- (15次奇点的隐藏效果：进入奇点后直接完成五次挑战8，获得一只蚁后，并获得2.22e2222粒子) ---- (20次奇点的隐藏效果：进入奇点后直接完成一次挑战9，获得一只神使蚁，夸克获取数量永久增加5%，获得商店的EX额外祭品、AUTO自动献祭祭品、EX额外难得素、AUTO难得素自动研究、蚂蚁速度、昂贵物品至满级(同时变为无法重置)) ---- (25次奇点的隐藏效果：进入奇点后直接获得1e100银河碎屑，并获得虔蚁护身符)'
    }
