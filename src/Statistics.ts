...
export const gameStages = (): Stage[] => {
    const stages: Stage[] = [
        ...
        {stage: 20, tier: 6, name: '奇点至八阶方块', unlocked: player.singularityUpgrades.octeractUnlock.level > 0, reset: player.singularityCount > 0},
        {stage: 21, tier: 6, name: '八阶方块', unlocked: false, reset: player.singularityCount > 0}
    ];
    return stages;
}
