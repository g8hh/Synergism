...
var cnItems = {
    ...
    '[6x4] Add +1 extra level to Crystal upgrade caps multiplied by Level * Log4(Common Fragments +': '[6x4]使水晶升级上限乘上 此研究等级 * log4(普通白底碎片 +',
    '[6x5] Unlock automation for Fortifying talismans! Activates every 2 real life seconds.': '[6x5]解锁自动强化护身符！现实时间每2秒激活一次。',
    '[6x6] Turn some Ant Disciples against Ant God, giving +0.5% Rune Effectiveness per level.': '[6x6]让一部分神使蚁转而对抗蚁神，每级使符文效率增加0.5%。',
    ...
    '[6x8] Using some coalesced Obtainium, you can make Ant Sacrifice 3% better per level.': '[6x8]联合难得素的能量，每级可以使蚂蚁献祭效果增加3%。',
    ...
    '[6x19] Your obtainium gain is increased by 3 * Log4(Uncommon Fragments + 1) * level%! Why is this? I don\'t know.': '[6x19]您的难得素获取数量增加 3 * log4(罕见绿底碎片 + 1) * 此研究等级%！为什么是这个公式？我也不知道。',
    ...
    '[6x22] Feed your ants their own crumbs to make them Log(Crumbs + 10)x faster!': '[6x22]给蚂蚁们喂食碎屑，以使它们的速度变为 Log(银河碎屑数 + 10) 倍！',
    ...
    '[6x25] Auto Challenge. Enough said. (Lets you automatically run and complete challenges!': '[6x25]解锁自动挑战。一目了然了。(您可以自动进行和完成挑战了！',
    '': '',
    '': '',
    '': '',
    '': '',
