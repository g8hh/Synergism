...
var cnItems = {
    ...
    'Go through a transcension, except Multipliers do not directly increase Multiplier. Instead, Multipliers act as Accelerators. Accelerator Power from Accelerator Boosts are nerfed by about 50%.': '立即完成一次超越,加倍不再像加倍一样工作,而是像加速器一样,并且加速器强化的效果削减50%',
...
var cnPrefix = {
    ...
    'Gotta go SLOW!: Prestige without buying Accelerators or Accelerator Boosts.': '正在变慢!:不购买加速器和加速器强化进行一次转生',
    'I\'m really going slow: Transcend without having bought Accelerators or Boosts.': '我真的变慢了:不购买加速器和加速器强化进行一次超越',
