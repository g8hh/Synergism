...
var cnItems = {
    ...
    'Gain +1% platonic cubes per level if >2.5 Trillion Score!': '如果飞升分数大于2.5e12，则每级此升级增加1%的PLATONIC方盒获取数量！',
    ...
    'C10 Exponent: 1.0375 --> 1.04, Const. tax exponent +0.20 and 10x faster constant production, +5/+3 Challenge caps, +250% Obtainium and Offerings, +100% Cubes/Tesseracts/Hypercubes/Platonics for 5T/7.5T/10T/20T score. ^1.25 ant exponent in C15!': 'C10的分数倍率的指数从1.0375变为1.04，数学常数减缓税收的指数增加0.2，数学常数产量变为10倍，挑战上限次数分别增加5和3，难得素和祭品获取数量增加250%，分别在5e12/7.5e12/1e13/2e13飞升分数时使方盒/超立方/五阶立方/PLATONIC方盒获取数量增加100%，在挑战15中蚂蚁产量变为蚂蚁产量^1.25！',
    '===Upgrade Costs===': '===升级成本===',
