...
var cnPrefix = {
    ...
    'Reward: +10%, +10 Multiplier Power Boosts per completion. First Completion awards 1 multiplier. This will be the your highest ever completions so you will also gain': '奖励:每次完成使加倍+10,+10%加成,首次完成获得一个加倍,每次完成会获得',
    'Reward: +5% Accel. Boost power, +5 free Accelerator per completion. Gain +0.5% higher Acceleration Power every 2 completions. This will be the your highest ever completions so you will also gain': '奖励:每次完成+5%加速器加成效果,每次完成+5免费加速器,每两次完成提高0.5%加速器加成奖励,每次完成会获得',
    ...
    'Reward: Each completions multiplies all crystal producer production by 10. Diamond gain is also increased significantly per completion. This will be the your highest ever completions so you will also gain': '奖励:每次完成都将使所有水晶生产者的产量提高10倍,钻石收益也会明显的提高,每次完成会获得',
