...
var cnPrefix = {
    ...
    'Reduce threshold for multiplier boosts by 0.0100 per level.': '每级降低加倍阈值0.0100',
    'Reduce threshold for multiplier boosts by 0.0075 per level.': '每级降低加倍阈值0.0075',
    'Reduce threshold for multiplier boosts by 0.0050 per level.': '每级降低加倍阈值0.0050',
    ...
    'Reward: Increase crystal multiplier to production by an exponent of .04 per completion. Purchased mythos producers will also increase mythos producers by +0.5% per producer per completion.': '奖励:每次完成以.04的指数增加水晶产量,每次完成后已购买的神话生产者酱额外提高神话神话产出0.5% ',
