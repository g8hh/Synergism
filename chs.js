...
var cnItems = {
    ...
    'When bought, rune effectiveness is increased by Log4(Talisman Shards +1) %': '购买后，符文效果增加 Log4(护身符灰底碎片 +1) % (译者注：注意，与升级等级无关)',
    'When bought, gain Log4(Constant + 1)% more Wow! Cubes and Tesseracts on ascension.': '购买后，飞升的惊奇方盒和惊奇超立方获取数量增加 Log4(数学常数数量 + 1)% (译者注：注意，与升级等级无关)',
    '': '',
    '': '',
    '': '',
    '': '',
