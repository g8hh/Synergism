...
var cnItems = {
    ...
    'Reward: 100 AP. 100 Quarks! Gain 20% of excess time after 10 seconds each Ascension as a linear multiplier to ascensions (max 24 hours). Gain +0.1% Cubes per 250,000 ascensions, up to +25%!': '奖励：100成就点数。100夸克！飞升时间超过10秒以后，超出部分的时间(最高24小时)的2%将变为飞升次数的倍率。且每250000次飞升使方盒获取量增加0.1%，最大为25%！',
    ...
    'Reward: 60 AP. 60 Quarks! Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions (max 24 hours). Gain +0.1% Tesseracts per 500,000 ascensions, up to +25%!': '奖励：60成就点数。60夸克！飞升时间超过10秒以后，超出部分的时间(最高24小时)的2%将变为飞升次数的倍率。且每500000次飞升使超立方获取量增加0.1%，最大为25%！',
    ...
    'Reward: 100 AP. 100 Quarks! Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions (max 24 hours). Gain +0.1% Hypercubes per 1,000,000 ascensions, up to +25%!': '奖励：100成就点数。100夸克！飞升时间超过10秒以后，超出部分的时间(最高24小时)的2%将变为飞升次数的倍率。且每1000000次飞升使五阶立方获取量增加0.1%，最大为25%！',
    ...
    'Reward: 100 AP. 100 Quarks! Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions (max 24 hours). Gain +0.1% Platonic Cubes per 1,337,000 ascensions, up to +25%!': '奖励：100成就点数。100夸克！飞升时间超过10秒以后，超出部分的时间(最高24小时)的2%将变为飞升次数的倍率。且每1337000次飞升使PLATONIC方盒获取量增加0.1%，最大为25%！',
    ...
    'C10 Exponent: 1.035 --> 1.0375, Constant tax exponent +0.10, 2x faster constant production, +5/+3 Challenge caps, +100% Obtainium/Offerings, ^1.10 coin gain in C15!': 'C10的分数倍率的指数从1.035变为变为1.0375，数学常数减缓税收的指数增加0.1，数学常数产量变为2倍，挑战上限次数分别增加5和3，难得素和祭品获取数量增加100%，在挑战15中金币产量变为金币产量^1.10！',
    'Raises corruption 1 and 2 exponent ^(1 + level/10), capacity of ^1 on Mult/Accel.': '将腐化 I和腐化 II的效果指数乘以(1+此升级等级/10)，但效果指数不能超过1。',
    'Raises speed below 1x to the power of ^(1 - level/20).': '全局速度低于1倍时，将速度变为速度的(1-(此升级等级/20))次方。',
    'Divides Hyperchallenged by its level, with a minimum 1x challenge req. multiplier!': '将腐化：极致挑战的效果指数除以(1+此升级等级)，但效果指数不能低于1！',
    'Gain more obtainium with the illiteracy corruption, up until 1e50 obtainium!': '腐化：科盲中可以获得更多难得素，最高到1e50难得素！',
    'C10 Exponent: 1.0375 --> 1.04, Const. tax exponent +0.20 and 10x faster constant production, +5/+3 Challenge caps, +250% Obtainium and Offerings, +100% Cubes/Tesseracts/Hypercubes/Platonics for 5T/7.5T/10T/20T score. ^1.25 ant exponent in C15!': 'C10的分数倍率的指数从1.0375变为1.04，数学常数减缓税收的指数增加0.2，数学常数产量变为10倍，挑战上限次数分别增加5和3，难得素和祭品获取数量增加250%，分别在5,000,000,000/7,500,000,000/10,000,000,000/20,000,000,000飞升分数时使方盒/超立方/五阶立方/PLATONIC方盒获取数量增加100%，在挑战15中蚂蚁产量变为蚂蚁产量^1.25！',
    '===Upgrade Costs===': '===升级成本===',
