        ...
        for (const key of singUpgrade) {
            ...
            switch (CNsingname) {
                ...
                case '[23] Citadel of Singularity':
                    CNsingname ='[23] 奇点堡垒';
                    break;
                case '[24] Citadel of Singularity: The Real Edition':
                    CNsingname ='[24] 真·奇点堡垒';
                    break;
                case '[25] Octeracts':
                    CNsingname ='[25] 惊奇八阶方块';
                    break;
                case '[26] Platonic $ells out!!!':
                    CNsingname ='[26] Platonic脱销！！！';
                    break;
                ...
                case '[NEW!] Citadel of Singularity':
                    CNsingname ='[新！] 奇点堡垒';
                    break;
                case '[NEW!] Citadel of Singularity: The Real Edition':
                    CNsingname ='[新！] 真·奇点堡垒';
                    break;
                case '[NEW!] Octeracts':
                    CNsingname ='[新！] 惊奇八阶方块';
