...
var cnRegReplace = new Map([
    ...
    [/^(.+) \[>500 ELO\]$/, '$1[强度分>500]'], //蚂蚁
    [/^(.+) \[>750 ELO\]$/, '$1[强度分>750]'], //蚂蚁
    [/^(.+) \[>1,000 ELO\]$/, '$1[强度分>1000]'], //蚂蚁
    [/^(.+) \[>1,500 ELO\]$/, '$1[强度分>1500]'], //蚂蚁
    [/^(.+) \[>2,000 ELO\]$/, '$1[强度分>2000]'], //蚂蚁
    [/^(.+) \[>3,000 ELO\]$/, '$1[强度分>3000]'], //蚂蚁
    [/^(.+) \[>5,000 ELO\]$/, '$1[强度分>5000]'], //蚂蚁
