...
() =>"Printer Prodction x" + format(Decimal.min(1e125, player.transcendShards.add(1))),
...
() =>"Your patience will allow you to gain " + format(Math.min(4, Math.max(1, Math.pow(player.reincarnationcounter/30,2))) * Math.pow(Math.min(19, 1 + 2 * player.reincarnationcounter / 400),2),2) + "x more Obtainium on Reincarnation.",
...
() =>"Offering Multiplier: x" + format((1 + 2 * Math.min(1, Math.pow(player.maxobtainium/100000, 0.5))),2),
() =>"Lorem ipsum",
() =>"Lorem ipsum",
() =>"Lorem ipsum",
() =>"Lorem ipsum",
...
var resdesc76 = "Got a lot of Obtainium saved? I hope you do! This research here will give you +1 Quarks per hour in your current reincarnation."
var resdesc77 = "Each level increases the cap on Speed rune by 1 per level. It also increases EXP on use by 1% per level if you're into that."
var resdesc78 = "Each level increases the cap on Duplication rune by 1 per level. It also increases EXP on use by 1% per level if you're into that."
var resdesc79 = "Each level increases the cap on Prism rune by 1 per level. It also increases EXP on use by 1% per level if you're into that."
var resdesc80 = "Each level increases the cap on Thrift rune by 1 per level. It also increases EXP on use by 1% per level if you're into that."
