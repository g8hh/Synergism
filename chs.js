...
var cnItems = {
    ...
    'Reward: Accelerator cost scaling starts 5 slower, and Multiplier cost scaling starts 2 slower per completion. Buildings scale 1% slower as well! This will be the your highest ever completions so you will also gain 1x Quarks!': '奖励:每次完成挑战加速器价格膨胀减缓5级,加倍价格膨胀减缓2级,建筑价格膨胀也会减缓1%,每次完成会获得一个夸克',
    'Reward: +10%, +10 Multiplier Power Boosts per completion. First Completion awards 1 multiplier. This will be the your highest ever completions so you will also gain 1x Quarks!': '奖励:每次完成使加倍+10,+10%加成,首次完成获得一个加倍,每次完成会获得一个夸克',
    ...
    'Reward: +5% Accel. Boost power, +5 free Accelerator per completion. Gain +0.5% higher Acceleration Power every 2 completions. This will be the your highest ever completions so you will also gain 1x Quarks!': '奖励:每次完成+5%加速器强化效果,+5免费加速器,每两次完成使加速器强化加成+0.5%,每次完成会获得一个夸克',
    ...
    'Reward: Increase crystal multiplier to production by an exponent of .04 per completion. Purchased mythos producers will also increase mythos producers by +0.5% per producer per completion. This will be the your highest ever completions so you will also gain 1x Quarks!': '奖励:每次完成以.04的指数增加水晶产量,每次完成后已购买的神话生产者酱额外提高神话神话产出0.5%,每次完成会获得一个夸克',
    ...
    'Reward: Each completions multiplies all crystal producer production by 10. Diamond gain is also increased significantly per completion. This will be the your highest ever completions so you will also gain 1x Quarks!': '奖励:每次完成都将使所有水晶生产者的产量提高10倍,钻石收益也会明显的提高,每次完成会获得一个夸克',
