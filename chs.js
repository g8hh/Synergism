...
var cnItems = {
    ...
    'Reward: 10 AP. 10 Quarks! Ant Multiplier from sacrifice is multiplied by another logarithm (Multiply by 0.4 * log10(points +': '奖励：10成就点数。10夸克！献祭获得的蚂蚁倍率乘以另一个对数倍率(乘以0.4 * log10(强度分 +',
