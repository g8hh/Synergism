...
var cnItems = {
    ...
    '[7x18] +Gain +0.08% blessings on cubes per level. You know, you should expect it at this point.': '[7x18]每级使惊奇方盒的祝福数量增加0.08%。您到这个时候应该预料的到。',
    '[7x19] +4% faster Tesseract Buildings / level. It\'s GROWING.': '[7x19]每级使超立方建筑的产量增加4%。它还在增加。',
    '[7x20] Tome 3 of 4: How to totally ROCK challenge 10. e100m divisor!': '[7x20]四部曲的第三部：如何完全搞定挑战10。再次减少1e100M！',
    ...
    '[7x24] Epic Fragments boost Blessing power by 10% * Log10(Epic Shards +': '史诗紫底碎片将祝福能量乘以 10% * Log10(史诗紫底碎片数量 +',
