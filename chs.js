...
var cnItems = {
    ...
    'Accelerator, +0.5% Accelerators per level. +1 Accelerator Boost every 10 levels!': '加速器,+0.5%加速器每级,+1加速器强化每10级',
    ...
    'building cost growth delay per level, +0.125% offering recycle chance per level [MAX: 25%]': '建筑价格成长削减,+0.125%回收祭品概率[最高25%]',
...
var cnPrefix = {
    ...
    'Increase all rune effects by 10%.': '所有符文效果增加10%',
    ...
    'Gain +1 free accelerator per accelerator boost.': '每个加速器加成额外提供1加速器',
    'Rune Effects are increased by 0.125% per level.': '每级提高符文效果0.125%',
    ...
    'Start Reincarnations with automatic A.Boosts unlocked.': '转世后立即获得加速器加成相关自动项',
    ...
    'Gain more Obtainium based on your particle gain.': '基于你可以获得的粒子增加你获得的难得素',
    'Effect: Cosmic Magnetics will allow you to gain': '效果:宇宙磁学允许你获得',
    'Gain more Obtainium based on how long your current reincarnation is.': '基于你转世时间增加你获得的难得素',
    ...
    'Completing challenges, automatically or manually, increase offerings gained in Reincarnation.': '已完成的挑战,无论自动或手动,都会增加你转世时获得的祭品数',
...
var cnPostfix = {
    ...
    'Quarks! Multiply Crystal Production by the common logarithm of owned Diamonds. Prestiges give more offerings based on time spent': '夸克!根据已持有的钻石的对数增加水晶产量,转生根据时间获得祭品',
    'Quarks! Accelerator Boosts can be purchased from any screen. Unlock the Auto-Prestige feature.': '夸克!加速器强化可以在顶部转生列表购买,解锁自动转生功能',
    'Quarks! Unlock the Prism Rune! Transcensions give more offerings based on time spent': '夸克!解锁棱镜符文!超越根据时间获得祭品',
