...
var cnItems = {
    ...
    'Got a code? Great! Enter it in (CaSe SeNsItIvE). [Note to viewer: this is for events and certain always-active codes. May I suggest you type in "synergism2021" or "add" or "daily" or "time" perchance?]': '有奖励代码吗？很好！在这里输入就可以了(注意大小写)。[注意：此处可以输入活动代码或者一些常时代码。您可以考虑输入“synergism2021”，“add”，“daily”或者“time”。]',
