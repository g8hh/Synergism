...
var cnItems = {
    ...
    'Ascending will reset all buildings, rune levels [NOT CAP!], talismans, most researches, and the anthill feature for Cubes of Power. Continue?': '飞升后，之前的所有低阶资源，符文等级[非上限！]，护身符，大部分研究，以及蚁丘都将被重置，但您可以获得方盒的力量。您确定要继续吗？',
    ...
    'Every Transcension Challenge completion increases Crystal gain by 1% per level.': '每级使每次转世挑战完成次数增加水晶产量1%。',
    ...
    '[252] Ultimate: Complete \'SADISTIC II\' Challenge.':'[252]终极挑战：完成虐待狂挑战 II。',
    ...
    'Red background: Unachieved, provides content/feature unlock.': '红色背景：成就可解锁游戏内容或机制，未完成。',
    ...
    'Unlock the Anthill feature! Includes 20 new Researches. A Global Diamond Upgrade.': '解锁蚁丘机制！解锁20个新研究。另外还解锁了一个全局钻石升级。',
    ...
    'Unlock the Talismans feature! [In Runes tab]. A Global Diamond Upgrade.': '解锁护身符机制！[在符文选项卡下]。另外还解锁了一个全局钻石升级。',
    ...
    'The worst atrocity a man can commit is witnessing, without anguish, the suffering of others.': '袖手旁观是人类最大的原罪。',
    'Ascend and reach the goal but you\'re stuck in all corruptions at level 11, and Ant production ^0.01.': '立即飞升开始挑战，腐化全部为11级，并且无法清除，蚂蚁产量^0.01。',
    'You will find no goal in sight, but get bonuses based on your best attempt.': '没有目标，根据您在此挑战中的最高金币数量获得奖励。',
    'Folly of mankind': '愚蠢的人类',
    'to believe they can defeat': '竟然会相信',
    'what Ant God labored': '他们可以打败蚁神',
    'You would break the universe if you could!': '如果您能做到的话，宇宙将会崩坏！',
    ...
    'Auto Timer': '扫荡计时',
    'Press [1], [2]... up to [0] to enter challenges 1 to 10. Press [E] to exit your Transcension or Reincarnation challenge if stuck!': '按[1]，[2]，一直到[0]来进入挑战1至挑战10。如果在挑战中卡住了，按[E]可以退出挑战！',
    'If you are unable to finish a Transcension challenge, press the hotkey listed above OR click on the red Challenge "C" button on the reset buttons on top.': '如果您无法完成超越挑战，可以按下上面列出的快捷键退出，或者点击顶部重置按钮上的红色 C 按钮来退出。',
    ...
    '[8x14] Legendary Fragments increase Spirit powers by +15% multiplied by Log10(Legendary Fragments +': '[8x14]传奇碎片将魂灵能量增加 15% * log10(传奇碎片数量 +',
    ...
    'Wow! A Singular Cookie of Pandora\'s Benefactory': '真惊奇！这是一块潘多拉的恩惠饼干。',
    'Wow! A Singular Cookie of Vyshareth\'s Benefactory': '真惊奇！这是一块腐化女神的恩惠饼干。',
    ...
    '[3x10] You now get +40% Cubes and Tesseracts forever!': '[3x10]从现在起，您永久多获得40%的方盒和超立方！',
    ...
    '12. Challenge 1-5 Requirement Scaling': '12. 挑战1至挑战5目标数值',
    '13. Challenge 6-10 Requirement Scaling': '13. 挑战6至挑战10目标数值',
    ...
    'Gain +2.4% Platonic Cubes per level! It is that simple.': '每级此升级使PLATONIC方盒获取数量增加2.4%！简单明了。',
    'C10 Exponent: 1.035 --> 1.0375, Constant tax exponent +0.10, 2x faster Constant production, +10% Quarks, +10 Reincarnation Challenge Cap, +5 Ascension Challenge Cap, 2x Obtainium and Offerings, ^1.10 coin gain in C15, as well +1 Corruption Cap Level!': 'C10的分数倍率的指数从1.035变为变为1.0375，数学常数减缓税收的指数增加0.1，数学常数产量变为2倍，夸克获取数量增加10%，转世挑战次数上限增加10次，飞升挑战次数上限增加5次，难得素和祭品获取数量翻倍，腐化等级上限增加1，在挑战15中金币产量变为金币产量^1.10！',
    'Multiplies Viscosity exponent by (1 + level/30), capacity of ^1 on Multipliers and Accelerators.': '将腐化：粘性的效果指数乘以(1+此升级等级/30)，但效果指数不能超过1。',
    'Raises speed below 1x to the power of ^(1 - level/30).': '全局速度低于1倍时，将速度变为速度的(1-(此升级等级/30))次方。',
    'Divides Hyperchallenged by (1 + 0.4 * level), with a minimum 1x Challenge requirement multiplier!': '将腐化：极致挑战的效果指数除以(1+0.4*此升级等级)，但效果指数不能低于1！',
    'Raise Obtainium to the power of (1+(0.09*log10(Obtainium owned))) and add another x2.5 multiplier (Uncorruptable), up until 1e100 Obtainium!': '难得素获取数量变为原来的(1+(0.09*log10(难得素当前数量)))次方，并且使难得素获取数量变为2.5倍(不受腐化影响)，最高到1e100难得素！',
    'C10 Exponent: 1.0375 --> 1.04, Constant tax exponent +0.20, 10x faster Constant production, +15% Quarks, +10 Reincarnation Challenge Cap, +5 Ascension Challenge Cap, 3.5x Obtainium and Offerings, 2x All Cubes, ^1.25 ant exponent in C15, +1 Corruption Cap Level again!': 'C10的分数倍率的指数从1.0375变为1.04，数学常数减缓税收的指数增加0.2，数学常数产量变为10倍，夸克获取数量增加15%，转世挑战次数上限增加10次，飞升挑战次数上限增加5次，难得素和祭品获取数量变为3.5倍，所有类型的方盒及立方获取数量翻倍，腐化等级上限增加1，在挑战15中蚂蚁产量变为蚂蚁产量^1.25！',
    ...
    'Gain (1 + lvl/100)x Ant multiplier per Challenge completion, ignoring corruptions to Ants.': '每完成1次挑战，就使蚂蚁倍率变为(1+此升级等级/100)倍，此效果无视腐化。',
    'Effect of Drought is raised to the power of 0.5.': '使腐化：干旱的效果变为原来的0.5次方。',
    ...
    'While I strongly recommended you not to buy this, you did it anyway. For that, you have unlocked the rune of Grandiloquence, for you are a richass.': '我都这么说了，您还是买了。好吧，您是土豪，我输了。您解锁了蚁神之古物符文。',
    '===Upgrade Costs===': '===升级成本===',
    ...
    'Warping is impossible (you get multiplier to Quarks instead': '您无法进行时空跃迁(变为获得更多夸克',
    ...
    'Turning this OFF, will consume all of your remaining Warps (without doing a Warp).\nAre you sure?': '关闭后将消耗您今日所有的跃迁次数(但没有任何收益)。您确定要这么做吗？',
    'Machine will need some time to cooldown (no Warps today).': '机器需要进行冷却(消耗今日所有的跃迁次数)。',
    'Machine didn\'t consumed your Warps.': '跃迁次数未发生变化。',
    'This machine will now be able to boost your Quarks gained from opening Cubes, based on how many Warps you have remaining. While its ON, warping will be impossible and turning it OFF won\'t be so easy.\nAre you sure you want to turn it ON?': '机器可以根据剩余的跃迁次数来增加开启方盒及立方的夸克获取数量了。但开启后，您将无法进行跃迁，且将它关闭需要付出一定代价。您确定要开启它吗？',
    'Machine will go into overdrive,\nonce you will have some Warps.': '机器将开始过载工作，但您目前没有跃迁次数。',
    'Machine is now on overdrive.': '机器开始了过载工作。',
    'Machine will continue to work as ussual, for now.': '机器将继续正常工作。',
    ...
    'Enter a Corruption Loadout to import for next Ascension. It must be in the following text format: 1/2/3/4/5/6/7/': '输入下次飞升使用的腐化预设。格式为：1/2/3/4/5/6/7/',
    'Your input was not in the correct format, try again.': '输入格式不对，请重新输入。',
    ...
    'Are you sure you want to enable copy save to clipboard?': '您确定要启用将存档导出到剪贴板吗？',
    'Export the game here': '点击此处导出游戏存档',
    'Copied save to clipboard!': '存档已导出到剪贴板！',
    ...
    'You didn\'t guess the right time, try again soon!': '点击的时机不对，下次再来吧！',
    ...
    'You\'re playing v2.9.31: December 22 v1 - The Alternate Reality [Last Update: 00:00 UTC 22-Dec-2022].': '您目前玩的版本为V2.9.31：12月22日第1版 - 另一个现实 [2022年12月22日 UTC 00:00更新]。',
    ...
    'AP Bonus': '成就点数加成',
    'Maxed Research': '升级满研究',
    'Maxed Cube upgrade': '升级满方盒升级',
    'Challenge 15 Reward': '挑战15奖励',
    'Patreon Bonus': 'Patreon加成',
    'Event Bonus': '活动加成',
    'Infinite Ascent Rune Bonus': '无限晋升符文加成',
    'Quark Hept Bonus': '惊奇七阶立方·夸克加成',
    'Powder Bonus': '超通量粉加成',
    ...
    'Achievement 262 Bonus': '成就262的加成',
    'Achievement 263 Bonus': '成就263的加成',
    'Intermediate Pack': '中级礼包',
    'Chronometer Z': '时计 Z',
    'Abstract Photokinetics': '抽象趋光性',
    'Abstract Exokinetics': '抽象外动力',
    'Ascension Speedup 2 [GQ]': '飞升的速度普通提升！[金夸克]',
    ...
    'Golden Quark Multipliers': '金夸克倍率',
    'Challenge 15 Exponent': '挑战15的指数',
    'Golden Quarks I': '金夸克 I',
    'Singularity Fast Forwards': '增加奇点次数升级的加成',
    'Golden Revolution II': '金之革命 II',
    ...
    'Obelisk Shaped Like an Octagon': '八角方尖碑',
    'Octahedral Synthesis': '八面合成',
    'Eighth Wonder of the World': '世界第八大奇迹',
    'Platonic is a fat sellout': 'Platonic卖到脱销',
    ...
    'Automatically pour Offerings into a rune. 1st level unlocks feature, and each level increases Offering gain by 2%. Every second, 2^(Level) levels worth of Offerings are spent.': '自动献祭祭品至符文中。第一级解锁机制，之后的每一级使祭品获取数量增加2%。只要祭品足够，每秒最多献祭祭品使符文增加2^(等级)的等级。',
    'Gain +4% more Obtainium from all sources!': '难得素获取数量增加4%！',
    'Automatically pour Obtainium into a research. 1st level unlocks feature, and each level increases Obtainium gain by 2%. Every Reincarnation, dump all Obtainium into research until maxed.': '自动使用难得素进行研究。第一级解锁机制，之后的每一级使难得素获取数量增加2%。每次转世，尽可能地使用难得素升级目标研究，激活方式与自动献祭类似。',
    'T and R Challenges don\'t cause resets if retry is enabled and gain up to 10 completions per tick. Additionally, instantly gain T Challenge completions up to highest completed when exiting R Challenges.': '只要开启重新尝试挑战，超越和转世挑战将不再重置资源，且每个时刻可以完成10次超越和转世挑战。另外，在退出转世挑战时，立刻使超越挑战的完成次数达到之前的完成次数上限。',
    'Each level gives a 1.2x speed multiplier to all Ant tiers\' production! (Uncorruptable!) Short and simple.': '每级使蚂蚁速度变为1.2倍！(不受腐化影响！)简单有效。',
    ...
    'Wow! Cubes is giving you a deal: Buy this totally fair Season Pass and gain +2.25% Cubes and Tesseracts per level when you Ascend!': '惊奇方盒提出交易：购买这个完全公平的季票以后，每级使您飞升的方盒和超立方获取数量增加2.25%！',
    ...
    'Five times the price gouge, twice the fun! +1.5% Wow! Hypercubes and Platonic Cubes per level.': '价格五倍，欢乐成对！每级使五阶立方和PLATONIC方盒获取数量增加1.5%！',
    'Okay, now this is just ridiculous. +1.5% Wow! Hepteracts and Octeracts per level!': '好吧，越来离谱了。每级使七阶立方和八阶方块获取数量增加1.5%！',
    'You know, those Ascensions are kinda slow. Why don\'t I give you a +1.2% speedup to the timer per level?': '您知道的，飞升慢的很。不如，每级使飞升的速度增加1.2%？',
    ...
    'With the power of Quacks Warp machine will now be able to go into overdrive': '利用夸克的力量，使跃迁机器可以进行过载工作',
    ...
    'CURRENT Effect: Warp machine can now go into overdrive.': '当前效果：跃迁机器可以过载工作了。',
    'CURRENT Effect: Warp machine can\'t go into overdrive, yet.': '当前效果：跃迁机器还不可以过载工作。',
    'Amount must be a finite, positive integer.': '这不是有效的数字啊。',
    ...
    ' (Softcapped': ' (已达软上限',
    '[1] Golden Quarks I': '[1] 金夸克 I',
    '[NEW!] Golden Quarks I': '[新！] 金夸克 I',
    'In the future, you will gain 10% more Golden Quarks on Singularities per level!': '每级使进入奇点的金夸克获取数量增加10%！',
    '[2] Golden Quarks II': '[2] 金夸克 II',
    '[NEW!] Golden Quarks II': '[新！] 金夸克 II',
    'Buying GQ is 0.2% cheaper per level! [After 50%, effect grows much slower]': '每级使商店购买金夸克的花费减少0.2%！[超过50%之后，效果将增长得更加缓慢]',
    '[3] Golden Quarks III': '[3] 金夸克 III',
    '[NEW!] Golden Quarks III': '[新！] 金夸克 III',
    ...
    '[4] Starter Pack': '[4] 新手大礼包',
    '[NEW!] Starter Pack': '[新！] 新手大礼包',
    ...
    '[5] Shop Bonanza': '[5] 商店促销',
    '[NEW!] Shop Bonanza': '[新！] 商店促销',
    ...
    '[6] Cookie Recipes I': '[6] 饼干配方 I',
    '[NEW!] Cookie Recipes I': '[新！] 饼干配方 I',
    ...
    '[7] Cookie Recipes II': '[7] 饼干配方 II',
    '[NEW!] Cookie Recipes II': '[新！] 饼干配方 II',
    ...
    '[8] Cookie Recipes III': '[8] 饼干配方 III',
    '[NEW!] Cookie Recipes III': '[新！] 饼干配方 III',
    ...
    '[9] Cookie Recipes IV': '[9] 饼干配方 IV',
    '[NEW!] Cookie Recipes IV': '[新！] 饼干配方 IV',
    ...
    '[11] Improved Ascension Gain': '[11] 更多飞升次数',
    '[NEW!] Improved Ascension Gain': '[新！] 更多飞升次数',
    ...
    '[12] Level Fourteen Corruptions': '[12] 腐化等级-十四',
    '[NEW!] Level Fourteen Corruptions': '[新！] 腐化等级-十四',
    ...
    '[13] Level Fifteen Corruptions': '[13] 腐化等级-十五',
    '[NEW!] Level Fifteen Corruptions': '[新！] 腐化等级-十五',
    ...
    '[27] Intermediate Pack': '[27] 中级礼包',
    '[NEW!] Intermediate Pack': '[新！] 中级礼包',
    ...
    '[28] Advanced Pack': '[28] 高级礼包',
    '[NEW!] Advanced Pack': '[新！] 高级礼包',
    ...
    '[29] Expert Pack': '[29] 专家礼包',
    '[NEW!] Expert Pack': '[新！] 专家礼包',
    ...
    '[30] Master Pack': '[30] 大师礼包',
    '[NEW!] Master Pack': '[新！] 大师礼包',
    ...
    '[31] Divine Pack': '[31] 神圣礼包',
    '[NEW!] Divine Pack': '[新！] 神圣礼包',
    ...
    '[32] Shop Liquidation Sale': '[32] 商店清仓大甩卖',
    '[NEW!] Shop Liquidation Sale': '[新！] 商店清仓大甩卖',
    ...
    '[48] QUAAAACK': '[48] 夸夸夸夸克',
    '[NEW!] QUAAAACK': '[新！] 夸夸夸夸克',
    ...
    '[33] Potion Decanter of Enlightenment': '[33] 启迪药水瓶',
    '[NEW!] Potion Decanter of Enlightenment': '[新！] 启迪药水瓶',
    'Purported to actually be the fountain of youth, this item powers up potions considerably!': '据称它其实是不老泉水，它可以极大地强化药剂！',
    '[34] Potion Decanter of Inquisition': '[34] 审查药水瓶',
    '[NEW!] Potion Decanter of Inquisition': '[新！] 审查药水瓶',
    'Staring at the glass, you aren\'t actually sure what this potion is.': '盯着瓶子看了一会儿，您还是没弄明白这到底是什么药水。',
    '[35] Potion Decanter of Maddening Instability': '[35] 暴躁不稳定药水瓶',
    '[NEW!] Potion Decanter of Maddening Instability': '[新！] 暴躁不稳定药水瓶',
    ...
    '[36] Bigger Challenge Caps': '[36] 挑战上限增加',
    '[NEW!] Bigger Challenge Caps': '[新！] 挑战上限增加',
    ...
    '[37] Biggerer Challenge Caps': '[37] 挑战上限再度增加',
    '[NEW!] Biggerer Challenge Caps': '[新！] 挑战上限再度增加',
    ...
    '[38] BiggererEST Challenge Caps': '[38] 挑战上限超级增加',
    '[NEW!] BiggererEST Challenge Caps': '[新！] 挑战上限超级增加',
    ...
    '[39] Marginal Quark Gain Improver Thingy': '[39] 略微增加夸克获取数量的小装置',
    ...
    '[40] I wish my Quark Hepteract was marginally better.': '[40] 我希望惊奇七阶立方·夸克的效果略微增加。',
    ...
    '[41] I wish my Quark Hepteract was marginally better II.': '[41] 我希望惊奇七阶立方·夸克的效果略微增加 II。',
    '[NEW!] I wish my Quark Hepteract was marginally better II.': '[新！] 我希望惊奇七阶立方·夸克的效果略微增加 II。',
    'Still not the right game. Same as the previous upgrade.': '还是走错游戏了。效果与之前类似。',
    '[42] I wish my Quark Hepteract was marginally better III.': '[42] 我希望惊奇七阶立方·夸克的效果略微增加 III。',
    '[NEW!] I wish my Quark Hepteract was marginally better III.': '[新！] 我希望惊奇七阶立方·夸克的效果略微增加 III。',
    'I AM NOT THE GODMOTHER YOU ARE LOOKING FOR, DYLAN!': '我！才！不！是！那！个！游！戏！里！的！教！母！(译者注：指NGU的Titan: Godmother)',
    '[43] Octeract Absinthe': '[43] 惊奇八阶方块苦艾酒',
    '[NEW!] Octeract Absinthe': '[新！] 惊奇八阶方块苦艾酒',
    'You would have never known this tonic can boost your Octeracts! [+1% per level, in fact!]': '想不到吧，这玩意可以增加惊奇八阶方块的获取数量[事实上每级可以使它增加1%！]',
    '[44] Pieces of Eight': '[44] 八个里亚尔',
    '[NEW!] Pieces of Eight': '[新！] 八个里亚尔',
    ...
    '[45] The Obelisk Shaped like an Octagon.': '[45] 八角方尖碑',
    '[NEW!] The Obelisk Shaped like an Octagon.': '[新！] 八角方尖碑',
    'Platonic had to reach pretty far here. +2% Octeracts yeah!': 'PLATONIC要走很远了。每级可以使惊奇八阶方块的获取数量增加2%！',
    '[46] Octahedral Synthesis': '[46] 八面合成',
    '[NEW!] Octahedral Synthesis': '[新！] 八面合成',
    'How does this even work!?? +1% Octeracts, you bet!': '这到底是怎么生效的！？？每级可以使惊奇八阶方块的获取数量增加1%！',
    '[47] The Eighth Wonder of the World': '[47] 世界第八大奇迹',
    '[NEW!] The Eighth Wonder of the World': '[新！] 世界第八大奇迹',
    ...
    '[49] The Ultimate Pen': '[49] 终极妙笔',
    '[NEW!] The Ultimate Pen': '[新！] 终极妙笔',
    'You. It is you who is the author of your own story!': '您。您才是自己故事的撰写人！',
    'You do  own the Ultimate Pen.  However, the pen just ran out of ink. How will you get more?': '您已拥有终极妙笔。但它没有墨水了。去哪再弄一些呢？',
    'You do NOT own the Ultimate Pen.': '您未拥有终极妙笔。',
    '[50] Platonic TAU': '[50] PLATONIC·陶',
    '[NEW!] Platonic TAU': '[新！] PLATONIC·陶',
    'Placed in the wrong upgrade section, this will remove any restrictions on corruptions or corruption level caps! Also raises 3d cube gain to the power of 1.01!': '似乎放到了错误的升级区域，它将使腐化解锁和腐化等级上限解锁的相应限制解除。另外，它还使惊奇方盒获取数量变为原来的1.01次方！',
    '[51] Platonic ALPHA...?': '[51] PLATONIC·阿 尔 法……？',
    '[NEW!] Platonic ALPHA...?': '[新！] PLATONIC·阿 尔 法……？',
    'Confusion ensues as to why there are two of these. This one is capitalized, so buying this ensures Platonic Alpha is always maxed!': '有两个阿尔法简直令人大惑不解。不过这一个阿尔法中间有空格，它可以使PLATONIC ALPHA升级永久为已升级！',
    '[52] Platonic DELTA': '[52] PLATONIC·德尔塔',
    '[NEW!] Platonic DELTA': '[新！] PLATONIC·德尔塔',
    ...
    '[53] Platonic PHI': '[53] PLATONIC·斐',
    '[NEW!] Platonic PHI': '[新！] PLATONIC·斐',
    ...
    '[54] Etherflux Singularities': '[54] 以太通量·奇点',
    '[NEW!] Etherflux Singularities': '[新！] 以太通量·奇点',
    'Golden Quark gained by Singularity is increased by 100% (additive), and going singular at your all time highest count gives +1 singularity count!': '使进入奇点的金夸克获取数量增加100%(效果相互叠加)，且在最高奇点次数时进入奇点将使奇点次数增加1次！',
    'You\'ve  transformed the Etherflux!': '您已转化以太通量！',
    'You\'ve NOT transformed the Etherflux!': '您未转化以太通量！',
    '[55] Aetherflux Singularities': '[55] 超以太通量·奇点',
    '[NEW!] Aetherflux Singularities': '[新！] 超以太通量·奇点',
    ...
    '[56] A hecking good ascension speedup!': '[56] 飞升的速度强力提升！',
    '[NEW!] A hecking good ascension speedup!': '[新！] 飞升的速度强力提升！',
    'Ascension Speed is raised to the power of 1.03, raised to 0.97 if less than 1x.': '如果飞升的速度低于1倍，则变为原来的0.97次方，否则变为原来的1.03次方。',
    '[57] A mediocre ascension speedup!': '[57] 飞升的速度普通提升！',
    '[NEW!] A mediocre ascension speedup!': '[新！] 飞升的速度普通提升！',
    ...
    '[59] QUQUQUQUAAKCKCKKCKKCKK': '[59] 夸夸夸夸克克克克克克',
    ...
    '[1] Octeracts for Dummies': '[1] 萌新的惊奇八阶方块',
    '[NEW!] Octeracts for Dummies': '[新！] 萌新的惊奇八阶方块',
    ...
    '[2] Octeract Cogenesis': '[2] 惊奇八阶方块同生',
    '[NEW!] Octeract Cogenesis': '[新！] 惊奇八阶方块同生',
    ...
    '[3] Octeract Trigenesis': '[3] 惊奇八阶方块三度起源',
    '[NEW!] Octeract Trigenesis': '[新！] 惊奇八阶方块三度起源',
    ...
    '[4] Quark Octeract': '[4] 惊奇八阶方块·夸克',
    '[NEW!] Quark Octeract': '[新！] 惊奇八阶方块·夸克',
    ...
    '[5] Octo-Hepteract Primality Synergism': '[5] 七-八阶原始协同',
    '[NEW!] Octo-Hepteract Primality Synergism': '[新！] 七-八阶原始协同',
    'For every 199 levels of Quark Octeract, you gain 0.01% more quarks per digit in your Quark Hepteract count per level!': '惊奇八阶方块·夸克每有199级，惊奇七阶立方·夸克每有一个数量级，每级该升级就可以使夸克获取数量增加0.01%。',
    'Octo-Hepteract Primality Synergism is  active.': '七-八阶原始协同效果已生效。',
    'Octo-Hepteract Primality Synergism is NOT active.': '七-八阶原始协同效果未生效。',
    '[6] EXTRA CHONKY Corruptions': '[6] 更多腐化',
    '[NEW!] EXTRA CHONKY Corruptions': '[新！] 更多腐化',
    'Adds one level to the cap on corruptions. Derpsmith approves.': '使腐化等级上限再增加1级。Derpsmith表示赞同。',
    '[7] EXTRA WIMPY Golden Quark Costs!': '[7] 金夸克购买花费再度降低',
    '[NEW!] EXTRA WIMPY Golden Quark Costs!': '[新！] 金夸克购买花费再度降低',
    'Reduces the cost of Golden Quarks in the shop by 1% per level.': '每级使商店购买金夸克的花费减少1%。',
    '[8] Improved Download Speeds': '[8] 改善下载速度',
    '[NEW!] Improved Download Speeds': '[新！] 改善下载速度',
    'Thanks to ethernet technology, export quarks are increased by 40% per level! Only normal ones.': '感谢伟大的以太网技术，每级使导出夸克奖励增加40%！',
    '[9] CHONKER Daily Code': '[9] 加强“Daily”代码效果',
    '[NEW!] CHONKER Daily Code': '[新！] 加强“Daily”代码效果',
    ...
    '[10] CHONKERER Daily Code': '[10] 再度加强“Daily”代码效果',
    '[NEW!] CHONKERER Daily Code': '[新！] 再度加强“Daily”代码效果',
    ...
    '[11] CHONKEREREST Daily Code': '[11] 超级加强“Daily”代码效果',
    '[NEW!] CHONKEREREST Daily Code': '[新！] 超级加强“Daily”代码效果',
    'It will never satisfy Derpsmith. +1 +0.5% more free Singularity upgrades per day from Daily!': 'Derpsmith永不自满。使“Daily”代码获得的免费奇点升级增加1级和增加0.5%！',
    '[12] I wish for even better Quark Hepteracts.': '[12] 我希望惊奇七阶立方·夸克的效果还能增加。',
    '[NEW!] I wish for even better Quark Hepteracts.': '[新！] 我希望惊奇七阶立方·夸克的效果还能增加。',
    ...
    '[13] The forbidden clock of time': '[13] 禁忌时钟',
    '[NEW!] The forbidden clock of time': '[新！] 禁忌时钟',
    ...
    '[14] Abstract Photokinetics': '[14] 抽象趋光性',
    '[NEW!] Abstract Photokinetics': '[新！] 抽象趋光性',
    'Gain +0.05% Ascension Speed per level per singularity!': '对于每次奇点，每级使飞升的速度增加0.05%！',
    '[15] Abstract Exokinetics': '[15] 抽象外动力',
    '[NEW!] Abstract Exokinetics': '[新！] 抽象外动力',
    'Gain +0.02% Ascension Speed per level per singularity!': '对于每次奇点，每级使飞升的速度增加0.02%！',
    '[16] Wow! I want free upgrades to be better.': '[16] 真惊奇！我希望免费升级效果变得更好。',
    '[NEW!] Wow! I want free upgrades to be better.': '[新！] 真惊奇！我希望免费升级效果变得更好。',
    ...
    '[17] Wow! Free upgrades still suck.': '[17] 真惊奇！免费升级还是不够给力。',
    '[NEW!] Wow! Free upgrades still suck.': '[新！] 真惊奇！免费升级还是不够给力。',
    'Who said beggars can\'t be choosers? Extends the exponent of the first upgrade to 0.65.': '谁规定免费就不能置喙了？使第一个升级的指数变为0.65。',
    '[18] Wow! Make free upgrades good already, Platonic!': '[18] 真惊奇！PLATONIC，让免费升级再度强大吧！',
    '[NEW!] Wow! Make free upgrades good already, Platonic!': '[新！] 真惊奇！PLATONIC，让免费升级再度强大吧！',
    'Extends the exponent of the free upgrades to 0.70.': '使免费升级的指数变为0.70。',
    '[19] Coupon of Ultimate Penniless Derpsmiths': '[19] 身无分文的Derpsmith之终极兑换券',
    '[NEW!] Coupon of Ultimate Penniless Derpsmiths': '[新！] 身无分文的Derpsmith之终极兑换券',
    ...
    '[20] Overwriting Pointers': '[20] 重写指针',
    '[NEW!] Overwriting Pointers': '[新！] 重写指针',
    ...
    '[21] Offering Electrolosis': '[21] 祭品电解',
    '[NEW!] Offering Electrolosis': '[新！] 祭品电解',
    'Gain 1% more offerings per level.': '每级使祭品获取数量增加1%。',
    '[22] Obtainium Deluge': '[22] 难得素之涌',
    '[NEW!] Obtainium Deluge': '[新！] 难得素之涌',
    'Gain 1% more obtainium per level.': '每级使难得素获取数量增加1%。',
    '[23] Voided Warranty': '[23] 保修失效',
    '[NEW!] Voided Warranty': '[新！] 保修失效',
    'Gain +1% Ascension Count per level, with a 2% bonus for every 10 levels.': '每级使飞升次数获取数量增加1%，每10级还可以使飞升次数获取数量额外增加2%。',
    '[24] Hidden Late Fees': '[24] 隐藏滞纳金',
    '[NEW!] Hidden Late Fees': '[新！] 隐藏滞纳金',
    ...
    '[25] Digital Octeract Accumulator': '[25] 八进制数码累加器',
    '[NEW!] Digital Octeract Accumulator': '[新！] 八进制数码累加器',
    'Octeract gain is 1% faster for every digit in your Ascension count!': '飞升次数每个数量级可以使惊奇八阶方块的获取数量增加1%！',
    '[26] Derpsmith\'s Singularity Discombobulator': '[26] Derpsmith的奇点小玩意',
    '[NEW!] Derpsmith\'s Singularity Discombobulator': '[新！] Derpsmith的奇点小玩意',
    ...
    '[27] Pill of Increased Thirst': '[27] 口渴药片',
    '[NEW!] Pill of Increased Thirst': '[新！] 口渴药片',
    ...
    '[28] Vitamin O Infusion': '[28] 维生素O灌注',
    '[NEW!] Vitamin O Infusion': '[新！] 维生素O灌注',
    'Thanks to the generosity of your Derpsmith, Potions are 2% more potent per level!': '感谢慷慨的Derpsmith，每级使药剂的效果增加2%！',
    '[29] Infinite Transcription of the One Mind': '[29] 无限转录一心',
...
var cnRegReplace = new Map([
    ...
    [/^Octeract production is (.+)% faster for every \$10 per month on the Patreon! Same as the Quark bonus which already exists.$/, 'Patreon上每月赞助金额每有10美元，就使惊奇八阶方块的获取数量增加$1%！数值跟现有的夸克获取数量加成一致。'], //奇点
    ...
    [/^You gain (.+)% more Quarks!$/, '夸克获取数量增加$1%！'], //奇点
    ...
    [/^Code 'daily' gives \+(.+) \+(.+)% more free Singularity upgrades per use.$/, '“Daily”代码可以额外提供$1级和$2%的免费奇点升级。'], //奇点，前置
    ...
    [/^One Mind converts Ascension Speed to Octeract Gain to the power of (.+).$/, '一心对八阶方块获取数量的加成变为$1次方。'], //奇点
