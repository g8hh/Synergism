...
var cnItems = {
    ...
    'Each purchased Crystal producer increases generation of Crystal producers by .1% per level. [MAX: 12%]': '每级使每购买一个水晶生产者增加0.1%的水晶生产者产量。[上限：12%]',
    'Improve the multiplier to coin production by .05 exponent per level. [MAX: +10.00]': '每级使水晶对金币产量提升的指数增加0.05。[上限：增加10.00]',
    ...
    'High-Tiered: Prestige for at least': '更高阶了：转生获得至少',
    'Highly Regarded: Prestige for at least 1e+100 Diamonds.': '备受推崇：转生获得至少1e100钻石。',
    'Highly Regarded: Prestige for at least': '备受推崇：转生获得至少',
    'Prestigious: Prestige for at least 1e+1000 Diamonds.': '威名远扬：转生获得至少1e1000钻石。',
    'Prestigious: Prestige for at least': '威名远扬：转生获得至少',
    'Legendary: Prestige for at least 1e+10000 Diamonds.': '成为传奇：转生获得至少1e10000钻石。',
    'Legendary: Prestige for at least': '成为传奇：转生获得至少',
    'Divine: Prestige for at least 1e+77777 Diamonds.': '具有神性：转生获得1e77777钻石。',
    'Divine: Prestige for at least': '具有神性：转生获得至少',
    'Perfectly Respected: Prestige for at least 1e+250000 Diamonds.': '无人不知：转生获得1e250000钻石。',
    'Perfectly Respected: Prestige for at least': '无人不知：转生获得至少',
    ...
    'Gotta get those Grandmasters Stronger: Complete [No Shards] ten times.': '加强宗师：完成十次无碎片挑战。',
    ...
    'Reward: 60 AP. 60 Quarks! Gain +100 ascension count for all ascensions longer than 10 seconds. Gain +1% Obtainium per 50,000 ascensions, up to +100%!': '奖励：60成就点数。60夸克！飞升时长超过10秒时，飞升次数增加100次。且每50000次飞升使难得素获取量增加1%，最大为100%！',
    'Reward: 100 AP. 100 Quarks! Gain 20% of excess time after 10 seconds each Ascension as a linear multiplier to ascensions. Gain +0.1% Cubes per 250,000 ascensions, up to +25%!': '奖励：100成就点数。100夸克！飞升时间超过10秒以后，超出部分的时间的20%将变为飞升次数的倍率。且每250000次飞升使方盒获取量增加0.1%，最大为25%！',
    ...
    'Reward: 60 AP. 60 Quarks! Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions. Gain +0.1% Tesseracts per 500,000 ascensions, up to +25%!': '奖励：60成就点数。60夸克！飞升时间超过10秒以后，超出部分的时间的20%将变为飞升次数的倍率。且每500000次飞升使超立方获取量增加0.1%，最大为25%！',
    ...
    'Reward: 60 AP. 60 Quarks! Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions.': '奖励：60成就点数。60夸克！飞升时间超过10秒以后，超出部分的时间的20%将变为飞升次数的倍率。',
    ...
    'Reward: 100 AP. 100 Quarks! Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions. Gain +0.1% Hypercubes per 1,000,000 ascensions, up to +25%!': '奖励：100成就点数。100夸克！飞升时间超过10秒以后，超出部分的时间的20%将变为飞升次数的倍率。且每1000000次飞升使五阶立方获取量增加0.1%，最大为25%！',
    ...
    'Reward: 100 AP. 100 Quarks! Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions. Gain +0.1% Platonic Cubes per 1,337,000 ascensions, up to +25%!': '奖励：100成就点数。100夸克！飞升时间超过10秒以后，超出部分的时间的20%将变为飞升次数的倍率。且每1337000次飞升使PLATONIC方盒获取量增加0.1%，最大为25%！',
    ...
    'Reward: 100 AP. 100 Quarks! You gain a permanent +60% Obtainium and Offering bonus, with +6% all cube types!': '奖励：100成就点数。100夸克！难得素和祭品获得数量永久增加60%，所有类型的方盒及立方获取数量永久增加6%！',
    'Reward: 100 AP. 100 Quarks! You gain a permanent +100% Obtainium and Offering bonus, with +10% all cube types!': '奖励：100成就点数。100夸克！难得素和祭品获得数量永久增加100%，所有类型的方盒及立方获取数量永久增加10%！',
    ...
    '[2x4] Iris shines her light on you. The effect power is now increased by +0.01 (+0.005 if >1000 blessings) per level.': '[2x4]伊丽丝照亮了您。每级使效果的指数增加0.01(如果超过1000祝福则改为增加0.005)。',
    '[2x5] Ares teaches you the art of war. The effect power is now increased by +0.01 (+0.0033 if >1000 blessings) per level.': '[2x5]阿瑞斯教导了您兵法韬略。每级使效果的指数增加0.01(如果超过1000祝福则改为增加0.0033)。',
    ...
    '[3x4] Plutus teaches you the Art of the Deal. The effect power is now increased by +0.01 (+0.0033 if >1000 blessings) per level.': '[3x4]普路托斯教导了您生意经。每级使效果的指数增加0.01(如果超过1000祝福则改为增加0.0033)。',
    '[3x5] Moloch lends you a hand in communicating with Ant God. The effect power is now increased by +0.01 (+0.0033 if >1000 blessings) per level.': '[3x5]摩洛克帮助您更好地与蚁神沟通。每级使效果的指数增加0.01(如果超过1000祝福则改为增加0.0033)。',
    ...
    '1. Coin Exponent: +': '1. 金币产量加成指数: +',
    '2. Taxes': '2. 税收',
    '3. Accelerator Boosts: +': '3. 加速器加成: +',
    '4. Multipliers: +': '4. 加倍器: +',
    '5. Rune EXP: +': '5. 符文经验值: +',
    '6. Rune Effectiveness: +': '6. 符文效果: +',
    '7. Challenge 1-5 Requirement Scaling': '7. 挑战1-5目标增加速度',
    '8. Challenge 6-10 Requirement Scaling': '8. 挑战6-10目标增加速度',
    '9. Obtainium: +': '9. 难得素: +',
    '10. Offerings: +': '10. 祭品: +',
    '11. Ant Speed: +': '11. 蚂蚁速度: +',
    '12. Bonus Ant Levels: +': '12. 蚂蚁额外等级: +',
    '13. Talisman Effectiveness: +': '13. 护身符效果: +',
    '14. Global Speed: +': '14. 全局速度: +',
    '15. Blessing Effectiveness: +': '15. 祝福效果: +',
    '16. Ascend Building Production: +': '16. 超立方建筑产量: +',
    '17. Cubes: +': '17. 方盒产量: +',
    '18. Tesseracts: +': '18. 超立方产量: +',
    '19. Hypercubes: +': '19. 五阶立方产量: +',
    '20. Platonics: +': '20. PLATONIC方盒产量: +',
    '21. Spirit Effectiveness: +': '21. 魂灵效果: +',
    '22. Ascension Score: +': '22. 飞升分数: +',
    ...
    'Gain +1% platonic cubes per level if >2.5 Trillion Score!': '如果飞升分数大于2,500,000,000,000，则每级此升级增加1%的PLATONIC方盒获取数量！',
    'C10 Exponent: 1.035 --> 1.0375, Constant tax exponent +0.10, 2x faster constant production, +5/+3 Challenge caps, +100% Obtainium/Offerings, ^1.10 coin gain in C15!': '在挑战15中获得以下效果：C10的分数倍率的指数从1.035变为变为1.0375，数学常数减缓税收的指数增加0.1，数学常数产量变为2倍，挑战上限次数分别增加5和3，难得素和祭品获取数量增加100%，金币产量变为金币产量^1.10！',
    ...
    'C10 Exponent: 1.0375 --> 1.04, Const. tax exponent +0.20 and 10x faster constant production, +5/+3 Challenge caps, +250% Obtainium and Offerings, +100% Cubes/Tesseracts/Hypercubes/Platonics for 5T/7.5T/10T/20T score. ^1.25 ant exponent in C15!': '在挑战15中获得以下效果：C10的分数倍率的指数从1.0375变为1.04，数学常数减缓税收的指数增加0.2，数学常数产量变为10倍，挑战上限次数分别增加5和3，难得素和祭品获取数量增加250%，分别在5,000,000,000/7,500,000,000/10,000,000,000/20,000,000,000飞升分数时使方盒/超立方/五阶立方/PLATONIC方盒获取数量增加100%，蚂蚁产量变为蚂蚁产量^1.25！',
    '===Upgrade Costs===': '===升级成本===',
    ...
    'Save': '存',
    'Load': '载',
    'This Ascension\'s climate raises ant production to the power of': '此飞升的气候使蚂蚁产量指数上升，指数为',
    'You have': '您有',
    ...
    'You\'re playing on v2.1.0 - The Abyss [Last Update: 4:45 PM UTC-8 Nov 13]': '您目前玩的版本为V2.1.0 - 深渊 [更新时间：11月13日西八区下午4:45]',
