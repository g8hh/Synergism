...
var cnItems = {
    ...
    '[5x5] Buy this and be able to run the first five challenges infinitely! (Note that requirements scale a LOT faster after': '[5x5]购买此研究后，将可以无限地进行前五个挑战！(请注意，挑战目标将急剧增加，当完成次数超过',
    ...
    '[5x18] For \'neutral\' talisman effects, increase by +0.06 per level!': '[5x18]每级使护身符无加成的符文增加0.06级！',
