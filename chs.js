...
var cnItems = {
    ...
    'Reward: 100 AP. 100 Quarks! Gain 20% of excess time after 10 seconds each Ascension as a linear multiplier to ascensions. Gain +0.1% Cubes per 250,000 ascensions, up to +25%!': '奖励：100成就点数。100夸克！飞升时间超过10秒以后，超出部分的时间的20%将变为飞升奖励的倍率。且每250000次飞升使方盒获取量增加0.1%，最大为25%！',
    ...
    'Reward: 60 AP. 60 Quarks! Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions. Gain +0.1% Tesseracts per 500,000 ascensions, up to +25%!': '奖励：60成就点数。60夸克！飞升时间超过10秒以后，超出部分的时间的20%将变为飞升奖励的倍率。且每500000次飞升使超立方获取量增加0.1%，最大为25%！',
    ...
    'Reward: 100 AP. 100 Quarks! Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions. Gain +0.1% Platonic Cubes per 1,337,000 ascensions, up to +25%!': '奖励：100成就点数。100夸克！飞升时间超过10秒以后，超出部分的时间的20%将变为飞升奖励的倍率。且每1337000次飞升使PLATONIC方盒获取量增加0.1%，最大为25%！',
    ...
    'Bonus Wow! Cubes': '惊奇方盒获取数量',
    'Bonus Wow! Tesseracts': '惊奇超立方获取数量',
    'Bonus Wow! Hypercubes': '惊奇五阶立方获取数量',
    'Bonus Platonic! Cubes': 'PLATONIC方盒获取数量',
