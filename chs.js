...
var cnItems = {
    ...
    'Multiplies Viscocity exponent by (1 + level/30), capacity of ^1 on Multipliers and Accelerators.': '将腐化：粘性的效果指数乘以(1+此升级等级/30)，但效果指数不能超过1。',
    ...
    'If Viscocity Corruption is set to level 10 or higher, score multiplier is raised by an exponent. That exponent is 3 + 0.04 per level of this upgrade.': '如果腐化：粘性的等级不低于10级，则使它的分数倍率变为原来的(3+0.04*此升级等级)次方。',
